...
`missingPackageIndices`, `presentPackagePaths`,
...
`presentPackages`, `presentPackagePaths`, `presentPackageIndices`,
...
`missingPackagePathCount`, `missingPackageIndexCount`,
...
`skippedStepScripts`, `passedStepIndices`, `passedStepIndexMap`,
