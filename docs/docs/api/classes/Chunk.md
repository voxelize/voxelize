...
| `vy` | `number` | The y voxel coordinate |
| `vz` | `number` | The z voxel coordinate |
| `color` | [`LightColor`](../modules.md#lightcolor-4) | The color of the light to get at the given voxel coordinate. |
...
| `color` | [`LightColor`](../modules.md#lightcolor-4) | The color of the light to set at the given voxel coordinate. |
...
through [getChunkName](ChunkUtils.md#getchunkname-4).

___

### params

• **params**: [`ChunkParams`](../modules.md#chunkparams-4)
...
| `params` | [`ChunkParams`](../modules.md#chunkparams-4) | The parameters to create a new chunk. |
