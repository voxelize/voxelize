...
• **params**: [`CharacterParams`](../modules.md#characterparams-2)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-2)\> | Parameters to create a Voxelize character. |
