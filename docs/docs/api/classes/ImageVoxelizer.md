...
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-2) | The extra parameters to process the image voxelization. |
...
| Name | Type |
| :------ | :------ |
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-2) |
| `url` | `string` |
