...
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-4) | The extra parameters to process the image voxelization. |
...
| Name | Type |
| :------ | :------ |
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-4) |
| `url` | `string` |
