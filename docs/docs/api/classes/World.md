...
- [atlas](World.md#atlas-4): A texture atlas that handles texture packing.
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `texture` | [`TextureData`](../modules.md#texturedata-4) | The data of the texture and where the texture is applying to. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `textures` | [`TextureData`](../modules.md#texturedata-4)[] | List of data to load into the game before the game starts. |
...
▸ **getBlockByTextureName**(`textureName`): [`Block`](../modules.md#block-4)
...
▸ **getBlockByWorld**(`wx`, `wy`, `wz`): [`Block`](../modules.md#block-4)
...
| `vy` | `number` | The voxel's Y position. |
| `vz` | `number` | The voxel's Z position. |
| `color` | [`LightColor`](../modules.md#lightcolor-4) | The color of the torch light to get. |
...
Use [getPreviousVoxelByVoxel](World.md#getpreviousvoxelbyvoxel-4) and [getPreviousVoxelByWorld](World.md#getpreviousvoxelbyworld-4) to get the previous
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `opaque?` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-4) | The chunk material that is used to render the opaque portions of the chunk meshes. |
| `transparent?` | { `back`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-4) ; `front`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-4)  } | The chunk materials that are used to render the transparent portions of the chunk meshes. This consists of two sides of the chunk mesh, front and back. |
| `transparent.back` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-4) | The back side of the chunk mesh's transparent material. |
| `transparent.front` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-4) | The front side of the chunk mesh's transparent material. |
...
Parameters to configure the world. This is a combination of the client-side parameters, [WorldClientParams](../modules.md#worldclientparams-4),
and the server-side parameters, [WorldServerParams](../modules.md#worldserverparams-4). The server-side parameters are defined on the server, and
...
| `atlas` | { `value`: `Texture`  } | The 2D texture atlas that is used to render the chunk. This will be set after [atlas](World.md#atlas-4) is generated. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `params` | `Partial`<[`WorldClientParams`](../modules.md#worldclientparams-4)\> | The client-side parameters to configure the world. |
