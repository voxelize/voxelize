...
• **params**: [`ControlsParams`](../modules.md#controlsparams-230)
...
• **state**: [`ControlState`](../modules.md#controlstate-230)
...
• **lookBlock**: [`Coords3`](../modules.md#coords3-230)
...
| :------ | :------ | :------ |
| `voxel` | [`Coords3`](../modules.md#coords3-230) | The coordinates of the potentially placeable block. Defaults to `(0, 0, 0)`. |
...
• `get` **position**(): [`Coords3`](../modules.md#coords3-230)

The 3D position that the client is at.

#### Returns

[`Coords3`](../modules.md#coords3-230)

___

### voxel

• `get` **voxel**(): [`Coords3`](../modules.md#coords3-230)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-230)

The chunk that the client is situated in.

#### Returns

[`Coords2`](../modules.md#coords2-230)
