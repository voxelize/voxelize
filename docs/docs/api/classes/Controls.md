...
• **state**: [`ControlState`](../modules.md#controlstate-36)
...
• **lookBlock**: [`Coords3`](../modules.md#coords3-36)
...
| :------ | :------ | :------ |
| `voxel` | [`Coords3`](../modules.md#coords3-36) | The coordinates of the potentially placeable block. Defaults to `(0, 0, 0)`. |
...
• `get` **position**(): [`Coords3`](../modules.md#coords3-36)

The 3D position that the client is at.

#### Returns

[`Coords3`](../modules.md#coords3-36)

___

### voxel

• `get` **voxel**(): [`Coords3`](../modules.md#coords3-36)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-36)

The chunk that the client is situated in.

#### Returns

[`Coords2`](../modules.md#coords2-36)
