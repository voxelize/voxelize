...
• **params**: [`ControlsParams`](../modules.md#controlsparams-210)
...
• **state**: [`ControlState`](../modules.md#controlstate-210)
...
• **lookBlock**: [`Coords3`](../modules.md#coords3-210)
...
| :------ | :------ | :------ |
| `voxel` | [`Coords3`](../modules.md#coords3-210) | The coordinates of the potentially placeable block. Defaults to `(0, 0, 0)`. |
...
• `get` **position**(): [`Coords3`](../modules.md#coords3-210)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-210)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-210)
