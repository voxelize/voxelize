...
Registry is by default created by the world and is available as [registry](World.md#registry-2).
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-2)[] | A list of blocks received from the server. |
...
• **ranges**: `Map`<`string`, [`TextureRange`](../modules.md#texturerange-2)\>
