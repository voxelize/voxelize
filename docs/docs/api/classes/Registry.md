...
• **params**: [`RegistryParams`](../modules.md#registryparams-128)
...
• **ranges**: `Map`<`string`, [`TextureRange`](../modules.md#texturerange-128)\>
...
| `transparent?` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-128) |
...
| :------ | :------ |
| `client` | [`Client`](Client.md) |
| `params` | `Partial`<[`RegistryParams`](../modules.md#registryparams-128)\> |
...
| Name | Type |
| :------ | :------ |
| `textures` | { `name`: `string` ; `side`: [`BlockFace`](../modules.md#blockface-128) ; `data`: `string` \| `Color`  }[] |
...
| :------ | :------ |
| `name` | `string` |
| `side` | [`BlockFace`](../modules.md#blockface-128) |
| `data` | `string` \| `Color` |
...
| Name | Type |
| :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-128)[] |
| `ranges` | `Object` |
...
▸ **getFacesByName**(`name`): [`BlockFace`](../modules.md#blockface-128)[]
...
[`BlockFace`](../modules.md#blockface-128)[]

___

### getFacesById

▸ **getFacesById**(`id`): [`BlockFace`](../modules.md#blockface-128)[]
...
| Name | Type |
| :------ | :------ |
| `block` | [`Block`](../modules.md#block-128) |
