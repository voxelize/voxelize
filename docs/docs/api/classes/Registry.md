...
• **params**: [`RegistryParams`](../modules.md#registryparams-64)
...
| Name | Type |
| :------ | :------ |
| `opaque?` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-64) |
| `transparent?` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-64) |
...
| :------ | :------ |
| `client` | [`Client`](Client.md) |
| `params` | `Partial`<[`RegistryParams`](../modules.md#registryparams-64)\> |
...
| Name | Type |
| :------ | :------ |
| `textures` | { `name`: `string` ; `side`: [`BlockFace`](../modules.md#blockface-64) ; `data`: `string` \| `Color`  }[] |
...
| :------ | :------ |
| `name` | `string` |
| `side` | [`BlockFace`](../modules.md#blockface-64) |
| `data` | `string` \| `Color` |
...
| Name | Type |
| :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-64)[] |
| `ranges` | `Object` |
...
▸ **getBlockByName**(`name`): [`Block`](../modules.md#block-64)
...
[`Block`](../modules.md#block-64)

___

### getBlockById

▸ **getBlockById**(`id`): [`Block`](../modules.md#block-64)
...
▸ **getFacesByName**(`name`): [`BlockFace`](../modules.md#blockface-64)[]
...
[`BlockFace`](../modules.md#blockface-64)[]

___

### getFacesById

▸ **getFacesById**(`id`): [`BlockFace`](../modules.md#blockface-64)[]
...
| Name | Type |
| :------ | :------ |
| `block` | [`Block`](../modules.md#block-64) |
