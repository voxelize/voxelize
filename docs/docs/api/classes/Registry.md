...
• **params**: [`RegistryParams`](../modules.md#registryparams-82)
...
| `transparent?` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-82) |
...
| :------ | :------ |
| `client` | [`Client`](Client.md) |
| `params` | `Partial`<[`RegistryParams`](../modules.md#registryparams-82)\> |
...
| Name | Type |
| :------ | :------ |
| `textures` | { `name`: `string` ; `side`: [`BlockFace`](../modules.md#blockface-82) ; `data`: `string` \| `Color`  }[] |
...
| :------ | :------ |
| `name` | `string` |
| `side` | [`BlockFace`](../modules.md#blockface-82) |
| `data` | `string` \| `Color` |
...
| Name | Type |
| :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-82)[] |
| `ranges` | `Object` |
...
▸ **getFacesByName**(`name`): [`BlockFace`](../modules.md#blockface-82)[]
...
[`BlockFace`](../modules.md#blockface-82)[]

___

### getFacesById

▸ **getFacesById**(`id`): [`BlockFace`](../modules.md#blockface-82)[]
...
| Name | Type |
| :------ | :------ |
| `block` | [`Block`](../modules.md#block-82) |
