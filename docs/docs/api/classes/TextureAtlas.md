...
• **params**: [`TextureAtlasParams`](../modules.md#textureatlasparams-4)
...
| `ranges` | `Map`<`string`, [`TextureRange`](../modules.md#texturerange-4)\> | The ranges on the texture atlas generated by the server. |
| `params` | [`TextureAtlasParams`](../modules.md#textureatlasparams-4) | The parameters used to create the texture atlas. |
