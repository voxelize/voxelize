...
| `params` | `Partial`<[`LightShinedParams`](../modules.md#lightshinedparams-2)\> | Parameters to customize the effect. |
...
• **params**: [`LightShinedParams`](../modules.md#lightshinedparams-2)
