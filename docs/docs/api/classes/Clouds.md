...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CloudsParams`](../modules.md#cloudsparams-2)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **params**: [`CloudsParams`](../modules.md#cloudsparams-2)
