...
| Name | Type |
| :------ | :------ |
| `meshData` | [`ServerMesh`](../modules.md#servermesh-12) |
| `materials` | `Object` |
...
| `listener` | `EventListener`<`Event`, `T`, [`ChunkMesh`](ChunkMesh.md)\> | The function that gets called when the event is fired. |
...
| `listener` | `EventListener`<`Event`, `T`, [`ChunkMesh`](ChunkMesh.md)\> | The listener function that gets removed. |
