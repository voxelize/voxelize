...
You can change the above bindings by calling [remap](Inputs.md#remap-2) with the corresponding input identifiers, namely
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-2) | `{}` | The specific parameters of the key to listen for. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-2) | `undefined` | The type of click to listen for. Either "left", "middle" or "right". |
...
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-2) | - |
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-2) | The specifics of the key to unbind. |
