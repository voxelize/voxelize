...
• **namespace**: [`InputNamespace`](../modules.md#inputnamespace-128) = `"menu"`
...
| :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-128) | Which mouse button to register on. |
| `callback` | () => `void` | What to do when that button is clicked. |
| `namespace` | [`InputNamespace`](../modules.md#inputnamespace-128) | Which namespace should this event be fired? |
...
| `namespace` | [`InputNamespace`](../modules.md#inputnamespace-128) | Which namespace should this even be fired? |
...
| `namespace` | [`InputNamespace`](../modules.md#inputnamespace-128) | The namespace in which the to fire this event. |
| `specifics` | `Object` | Used to specify in more details when/where the press occurs. |
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-128) | Which pressing occasion should the event be fired. Defaults to "keydown". |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `namespace` | [`InputNamespace`](../modules.md#inputnamespace-128) | The namespace to set to. |
