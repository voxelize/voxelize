...
• **namespace**: [`InputNamespace`](../modules.md#inputnamespace-72) = `"menu"`
...
| :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-72) | Which mouse button to register on. |
| `callback` | () => `void` | What to do when that button is clicked. |
| `namespace` | [`InputNamespace`](../modules.md#inputnamespace-72) | Which namespace should this event be fired? |
...
| `namespace` | [`InputNamespace`](../modules.md#inputnamespace-72) | Which namespace should this even be fired? |
...
| `namespace` | [`InputNamespace`](../modules.md#inputnamespace-72) | The namespace in which the to fire this event. |
| `specifics` | `Object` | Used to specify in more details when/where the press occurs. |
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-72) | Which pressing occasion should the event be fired. Defaults to "keydown". |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `namespace` | [`InputNamespace`](../modules.md#inputnamespace-72) | The namespace to set to. |
