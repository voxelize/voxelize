...
| Name | Type |
| :------ | :------ |
| `params` | `Partial`<[`CanvasBoxParams`](../modules.md#canvasboxparams-82)\> |
...
| :------ | :------ | :------ |
| `side` | [`BoxSides`](../modules.md#boxsides-82) \| [`BoxSides`](../modules.md#boxsides-82)[] | `undefined` |
| `art` | `Texture` \| [`ArtFunction`](../modules.md#artfunction-82) \| `Color` | `undefined` |
| `layer` | `number` | `0` |
