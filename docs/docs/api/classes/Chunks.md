...
• **toProcess**: [`ServerChunk`](../modules.md#serverchunk-18)[] = `[]`

___

### toUpdate

• **toUpdate**: [`BlockUpdate`](../modules.md#blockupdate-18)[] = `[]`
...
• **currentChunk**: [`Coords2`](../modules.md#coords2-18)
