...
• **toProcess**: [`ServerChunk`](../modules.md#serverchunk-44)[] = `[]`

___

### toUpdate

• **toUpdate**: [`BlockUpdate`](../modules.md#blockupdate-44)[] = `[]`
...
• **currentChunk**: [`Coords2`](../modules.md#coords2-44)
