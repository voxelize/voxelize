...
• **toProcess**: [`ServerChunk`](../modules.md#serverchunk-66)[] = `[]`

___

### toUpdate

• **toUpdate**: [`BlockUpdate`](../modules.md#blockupdate-66)[] = `[]`
...
• **currentChunk**: [`Coords2`](../modules.md#coords2-66)
