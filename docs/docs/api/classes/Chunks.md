...
• **toProcess**: [`ServerChunk`](../modules.md#serverchunk-92)[] = `[]`

___

### toUpdate

• **toUpdate**: [`BlockUpdate`](../modules.md#blockupdate-92)[] = `[]`
...
• **currentChunk**: [`Coords2`](../modules.md#coords2-92)
