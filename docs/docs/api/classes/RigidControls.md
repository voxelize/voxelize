...
• **params**: [`RigidControlsParams`](../modules.md#rigidcontrolsparams-2)
...
| `options` | `Partial`<[`RigidControlsParams`](../modules.md#rigidcontrolsparams-2)\> | The options to initialize the controls with. |
