...
| :------ | :------ | :------ | :------ |
| `coords` | [`Coords2`](../modules.md#coords2-2) | `undefined` | The coordinates to convert. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `coords` | [`Coords3`](../modules.md#coords3-2) | `undefined` | The coordinates to convert. |
| `concat` | `string` | `"|"` | The concatenation string to use. |
...
▸ `Static` **mapChunkToVoxel**(`chunkPos`, `chunkSize`): [`Coords3`](../modules.md#coords3-2)
...
| :------ | :------ | :------ |
| `chunkPos` | [`Coords2`](../modules.md#coords2-2) | The chunk coordinate to map. |
...
▸ `Static` **mapVoxelToChunk**(`voxelPos`, `chunkSize`): [`Coords2`](../modules.md#coords2-2)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `voxelPos` | [`Coords3`](../modules.md#coords3-2) | The voxel coordinate to map. |
| `chunkSize` | `number` | The horizontal dimension of a chunk. |
...
▸ `Static` **mapVoxelToChunkLocal**(`voxelPos`, `chunkSize`): [`Coords3`](../modules.md#coords3-2)
...
▸ `Static` **mapWorldToVoxel**(`worldPos`): [`Coords3`](../modules.md#coords3-2)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `worldPos` | [`Coords3`](../modules.md#coords3-2) | The world coordinate to map. |
...
▸ `Static` **scaleCoordsF**(`coords`, `factor`): [`Coords3`](../modules.md#coords3-2)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `coords` | [`Coords3`](../modules.md#coords3-2) | The coordinates to scale and floor. |
