...
| `dynamicFn` | (`pos`: [`Coords3`](modules.md#coords3-4)) => \{ `aabbs`: [`Block`](modules.md#block-4)[``"aabbs"``] ; `faces`: [`Block`](modules.md#block-4)[``"faces"``] ; `isTransparent`: [`Block`](modules.md#block-4)[``"isTransparent"``]  } | - |
| `dynamicPatterns` | [`BlockDynamicPattern`](interfaces/BlockDynamicPattern.md)[] | - |
| `faces` | \{ `corners`: \{ `pos`: [`number`, `number`, `number`] ; `uv`: `number`[]  }[] ; `dir`: [`number`, `number`, `number`] ; `independent`: `boolean` ; `isolated`: `boolean` ; `name`: `string` ; `range`: [`UV`](modules.md#uv-4)  }[] | A list of block face data that this block has. |
...
| `voxel` | [`Coords3`](modules.md#coords3-4) |

___

### BlockEntityUpdateListener

Ƭ **BlockEntityUpdateListener**\<`T`\>: (`args`: [`BlockEntityUpdateData`](modules.md#blockentityupdatedata-4)\<`T`\>) => `void`
...
| Name | Type |
| :------ | :------ |
| `args` | [`BlockEntityUpdateData`](modules.md#blockentityupdatedata-4)\<`T`\> |
...
Ƭ **BlockRule**: \{ `type`: ``"none"``  } \| \{ `type`: ``"simple"``  } & [`BlockSimpleRule`](modules.md#blocksimplerule-4) \| \{ `logic`: [`BlockRuleLogic`](enums/BlockRuleLogic.md) ; `rules`: [`BlockRule`](modules.md#blockrule-4)[] ; `type`: ``"combination"``  }
...
| :------ | :------ |
| `id?` | `number` |
| `offset` | [`Coords3`](modules.md#coords3-4) |
...
Ƭ **BlockUpdateListener**: (`args`: \{ `newValue`: `number` ; `oldValue`: `number` ; `voxel`: [`Coords3`](modules.md#coords3-4)  }) => `void`
...
| `args.voxel` | [`Coords3`](modules.md#coords3-4) |
...
| `update` | [`BlockUpdate`](modules.md#blockupdate-4) |
...
| `shape` | [`Coords3`](modules.md#coords3-4) |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `arms?` | `Partial`\<[`ArmsOptions`](modules.md#armsoptions-4)\> | Parameters to create the character's arms. |
| `body?` | `Partial`\<[`BodyOptions`](modules.md#bodyoptions-4)\> | Parameters to create the character's body. |
| `head?` | `Partial`\<[`HeadOptions`](modules.md#headoptions-4)\> | Parameters to create the character's head. |
| `idleArmSwing?` | `number` | The speed at which the arms swing when the character is idle. Defaults to `0.06`. |
| `legs?` | `Partial`\<[`LegOptions`](modules.md#legoptions-4)\> | Parameters to create the character's legs. |
| `nameTagOptions?` | `Partial`\<[`NameTagOptions`](modules.md#nametagoptions-4)\> | - |
...
Ƭ **ChunkMeshUpdateEventData**: [`ChunkMeshEventData`](modules.md#chunkmesheventdata-4) & \{ `reason`: [`ChunkUpdateReason`](modules.md#chunkupdatereason-4)  }

___

### ChunkUpdateEventData

Ƭ **ChunkUpdateEventData**: [`ChunkEventData`](modules.md#chunkeventdata-4) & \{ `reason`: [`ChunkUpdateReason`](modules.md#chunkupdatereason-4)  }
...
| `description` | `string` |
| `flags` | `string`[] |
| `process` | [`CommandProcessor`](modules.md#commandprocessor-4) |
...
| `onByDefault` | `boolean` | Whether or not should the debug panel be displayed by default when the page loads. Defaults to `true`. You can toggle the debug panel by calling [Debug.toggle](classes/Debug.md#toggle-4). |
...
| Name | Type |
| :------ | :------ |
| `boundingBox` | [`BoundingBox`](modules.md#boundingbox-4) |
| `color` | [`LightColor`](modules.md#lightcolor-4) |
| `jobId` | `string` |
| `lightOps` | \{ `floods`: [`LightNode`](modules.md#lightnode-4)[] ; `removals`: [`Coords3`](modules.md#coords3-4)[]  } |
| `lightOps.floods` | [`LightNode`](modules.md#lightnode-4)[] |
| `lightOps.removals` | [`Coords3`](modules.md#coords3-4)[] |
| `retryCount` | `number` |
...
| Name | Type |
| :------ | :------ |
| `floods` | \{ `blue`: [`LightNode`](modules.md#lightnode-4)[] ; `green`: [`LightNode`](modules.md#lightnode-4)[] ; `red`: [`LightNode`](modules.md#lightnode-4)[] ; `sunlight`: [`LightNode`](modules.md#lightnode-4)[]  } |
| `floods.blue` | [`LightNode`](modules.md#lightnode-4)[] |
| `floods.green` | [`LightNode`](modules.md#lightnode-4)[] |
| `floods.red` | [`LightNode`](modules.md#lightnode-4)[] |
| `floods.sunlight` | [`LightNode`](modules.md#lightnode-4)[] |
| `hasOperations` | `boolean` |
| `removals` | \{ `blue`: [`Coords3`](modules.md#coords3-4)[] ; `green`: [`Coords3`](modules.md#coords3-4)[] ; `red`: [`Coords3`](modules.md#coords3-4)[] ; `sunlight`: [`Coords3`](modules.md#coords3-4)[]  } |
| `removals.blue` | [`Coords3`](modules.md#coords3-4)[] |
| `removals.green` | [`Coords3`](modules.md#coords3-4)[] |
| `removals.red` | [`Coords3`](modules.md#coords3-4)[] |
| `removals.sunlight` | [`Coords3`](modules.md#coords3-4)[] |
...
| `appliedDeltas.lastSequenceId` | `number` |
| `jobId` | `string` |
| `modifiedChunks` | \{ `coords`: [`Coords2`](modules.md#coords2-4) ; `lights`: `Uint32Array`  }[] |
...
| Name | Type |
| :------ | :------ |
| `newBlock` | [`Block`](modules.md#block-4) |
| `newId` | `number` |
| `newRotation` | [`BlockRotation`](classes/BlockRotation.md) |
| `oldBlock` | [`Block`](modules.md#block-4) |
| `oldId` | `number` |
...
| `initialDirection` | [`Coords3`](modules.md#coords3-4) | - |
...
| Name | Type |
| :------ | :------ |
| `chunk-data-loaded` | (`data`: [`ChunkDataEventData`](modules.md#chunkdataeventdata-4)) => `void` |
| `chunk-loaded` | (`data`: [`ChunkEventData`](modules.md#chunkeventdata-4)) => `void` |
| `chunk-mesh-loaded` | (`data`: [`ChunkMeshEventData`](modules.md#chunkmesheventdata-4)) => `void` |
| `chunk-mesh-unloaded` | (`data`: [`ChunkMeshEventData`](modules.md#chunkmesheventdata-4)) => `void` |
| `chunk-mesh-updated` | (`data`: [`ChunkMeshUpdateEventData`](modules.md#chunkmeshupdateeventdata-4)) => `void` |
| `chunk-unloaded` | (`data`: [`ChunkEventData`](modules.md#chunkeventdata-4)) => `void` |
| `chunk-updated` | (`data`: [`ChunkUpdateEventData`](modules.md#chunkupdateeventdata-4)) => `void` |
...
| `cloudsOptions` | `Partial`\<[`CloudsOptions`](modules.md#cloudsoptions-4)\> | The options to create the clouds. Defaults to `{}`. |
...
| `skyOptions` | `Partial`\<[`SkyOptions`](modules.md#skyoptions-4)\> | The options to create the sky. Defaults to `{}`. |
...
Ƭ **WorldOptions**: [`WorldClientOptions`](modules.md#worldclientoptions-4) & [`WorldServerOptions`](modules.md#worldserveroptions-4)

The options to create a world. This consists of [WorldClientOptions](modules.md#worldclientoptions-4) and [WorldServerOptions](modules.md#worldserveroptions-4).
...
• `Const` **defaultArmsOptions**: [`ArmsOptions`](modules.md#armsoptions-4)

___

### defaultBodyOptions

• `Const` **defaultBodyOptions**: [`BodyOptions`](modules.md#bodyoptions-4)

___

### defaultCharacterOptions

• `Const` **defaultCharacterOptions**: [`CharacterOptions`](modules.md#characteroptions-4)

___

### defaultHeadOptions

• `Const` **defaultHeadOptions**: [`HeadOptions`](modules.md#headoptions-4)

___

### defaultLegsOptions

• `Const` **defaultLegsOptions**: [`LegOptions`](modules.md#legoptions-4)
