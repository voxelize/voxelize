...
Ƭ **ArmsOptions**: [`CanvasBoxOptions`](modules.md#canvasboxoptions-168) & \{ `shoulderDrop?`: `number` ; `shoulderGap?`: `number`  }
...
| `dynamicFn` | (`pos`: [`Coords3`](modules.md#coords3-168)) => \{ `aabbs`: [`Block`](modules.md#block-168)[``"aabbs"``] ; `faces`: [`Block`](modules.md#block-168)[``"faces"``] ; `isTransparent`: [`Block`](modules.md#block-168)[``"isTransparent"``]  } | If this block is dynamic, this function will be called to generate the faces and AABB's. By default, this just returns the faces and AABB's that are defined in the block data. |
| `dynamicPatterns` | \{ `aabbs`: [`Block`](modules.md#block-168)[``"aabbs"``] ; `faces`: [`Block`](modules.md#block-168)[``"faces"``] ; `isTransparent`: [`Block`](modules.md#block-168)[``"isTransparent"``] ; `rules`: \{ `id?`: `number` ; `offset`: [`Coords3`](modules.md#coords3-168) ; `rotation?`: [`BlockRotation`](classes/BlockRotation.md) ; `stage?`: `number`  }[]  }[] | - |
| `faces` | \{ `corners`: \{ `pos`: [`number`, `number`, `number`] ; `uv`: `number`[]  }[] ; `dir`: [`number`, `number`, `number`] ; `independent`: `boolean` ; `name`: `string` ; `range`: [`UV`](modules.md#uv-168)  }[] | A list of block face data that this block has. |
...
Ƭ **BodyOptions**: [`CanvasBoxOptions`](modules.md#canvasboxoptions-168)
...
Ƭ **HeadOptions**: [`CanvasBoxOptions`](modules.md#canvasboxoptions-168) & \{ `neckGap?`: `number`  }
...
Ƭ **LegOptions**: [`CanvasBoxOptions`](modules.md#canvasboxoptions-168) & \{ `betweenLegsGap?`: `number`  }
