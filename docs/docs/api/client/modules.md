...
| `faces` | { `corners`: { `pos`: `number`[] ; `uv`: `number`[]  }[] ; `dir`: `number`[] ; `independent`: `boolean` ; `name`: `string` ; `range`: [`TextureRange`](modules.md#texturerange-2)  }[] | A list of block face data that this block has. |
...
| `dimensions` | [`Coords3`](modules.md#coords3-2) | The dimension of each cloud block. Defaults to `[20, 20, 20]`. |
...
| Name | Type |
| :------ | :------ |
| `dimensions` | [`Coords3`](modules.md#coords3-2) |
| `max` | [`Coords3`](modules.md#coords3-2) |
| `min` | [`Coords3`](modules.md#coords3-2) |
| `realMax` | [`Coords3`](modules.md#coords3-2) |
| `realMin` | [`Coords3`](modules.md#coords3-2) |
...
| `perspective` | [`CameraPerspective`](modules.md#cameraperspective-2) |
| `slotClass` | `string` |
...
| `perspective` | [`CameraPerspective`](modules.md#cameraperspective-2) | The position of where the camera should be looking at. Defaults to `pxyz`, which means that the camera will be looking at the center of the object from the positive x, y, and z axis scaled by the zoom. |
...
| `initialPosition` | [`Coords3`](modules.md#coords3-2) | Initial position of the client. Defaults to `(0, 80, 10)`. |
...
• `Const` **BOX\_SIDES**: [`BoxSides`](modules.md#boxsides-2)[]
...
| Name | Type |
| :------ | :------ |
| `drawCrown` | [`ArtFunction`](modules.md#artfunction-2) |
...
▸ **cull**(`array`, `options`): `Promise`<[`MeshResultType`](modules.md#meshresulttype-2)\>
...
| `options` | [`CullOptionsType`](modules.md#culloptionstype-2) |

#### Returns

`Promise`<[`MeshResultType`](modules.md#meshresulttype-2)\>
