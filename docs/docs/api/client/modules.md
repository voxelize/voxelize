...
Ƭ **ArmsOptions**: [`CanvasBoxOptions`](modules.md#canvasboxoptions-404) & \{ `shoulderDrop?`: `number` ; `shoulderGap?`: `number`  }
...
| `dynamicFn` | (`pos`: [`Coords3`](modules.md#coords3-404)) => \{ `aabbs`: [`Block`](modules.md#block-404)[``"aabbs"``] ; `faces`: [`Block`](modules.md#block-404)[``"faces"``] ; `isTransparent`: [`Block`](modules.md#block-404)[``"isTransparent"``]  } | If this block is dynamic, this function will be called to generate the faces and AABB's. By default, this just returns the faces and AABB's that are defined in the block data. |
| `dynamicPatterns` | \{ `aabbs`: [`Block`](modules.md#block-404)[``"aabbs"``] ; `faces`: [`Block`](modules.md#block-404)[``"faces"``] ; `isTransparent`: [`Block`](modules.md#block-404)[``"isTransparent"``] ; `rules`: \{ `id?`: `number` ; `offset`: [`Coords3`](modules.md#coords3-404) ; `rotation?`: [`BlockRotation`](classes/BlockRotation.md) ; `stage?`: `number`  }[]  }[] | - |
| `faces` | \{ `corners`: \{ `pos`: [`number`, `number`, `number`] ; `uv`: `number`[]  }[] ; `dir`: [`number`, `number`, `number`] ; `independent`: `boolean` ; `name`: `string` ; `range`: [`UV`](modules.md#uv-404)  }[] | A list of block face data that this block has. |
...
Ƭ **BlockUpdateListener**: (`args`: \{ `newValue`: `number` ; `oldValue`: `number` ; `voxel`: [`Coords3`](modules.md#coords3-404)  }) => `void`
...
| `args.voxel` | [`Coords3`](modules.md#coords3-404) |
...
Ƭ **BodyOptions**: [`CanvasBoxOptions`](modules.md#canvasboxoptions-404)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `arms?` | `Partial`\<[`ArmsOptions`](modules.md#armsoptions-404)\> | Parameters to create the character's arms. |
| `body?` | `Partial`\<[`BodyOptions`](modules.md#bodyoptions-404)\> | Parameters to create the character's body. |
| `head?` | `Partial`\<[`HeadOptions`](modules.md#headoptions-404)\> | Parameters to create the character's head. |
| `idleArmSwing?` | `number` | The speed at which the arms swing when the character is idle. Defaults to `0.06`. |
| `legs?` | `Partial`\<[`LegOptions`](modules.md#legoptions-404)\> | Parameters to create the character's legs. |
| `nameTagOptions?` | `Partial`\<[`NameTagOptions`](modules.md#nametagoptions-404)\> | - |
...
| `dimensions` | [`Coords3`](modules.md#coords3-404) | The dimension of each cloud block. Defaults to `[20, 20, 20]`. |
...
| Name | Type |
| :------ | :------ |
| `dimensions` | [`Coords3`](modules.md#coords3-404) |
| `max` | [`Coords3`](modules.md#coords3-404) |
| `min` | [`Coords3`](modules.md#coords3-404) |
| `realMax` | [`Coords3`](modules.md#coords3-404) |
| `realMin` | [`Coords3`](modules.md#coords3-404) |
...
| `onByDefault` | `boolean` | Whether or not should the debug panel be displayed by default when the page loads. Defaults to `true`. You can toggle the debug panel by calling [Debug.toggle](classes/Debug.md#toggle-404). |
...
Ƭ **HeadOptions**: [`CanvasBoxOptions`](modules.md#canvasboxoptions-404) & \{ `neckGap?`: `number`  }
...
| `occasion?` | [`InputOccasion`](modules.md#inputoccasion-404) | The occasion that the input should be fired. Defaults to `keydown`. |
...
Ƭ **LegOptions**: [`CanvasBoxOptions`](modules.md#canvasboxoptions-404) & \{ `betweenLegsGap?`: `number`  }
...
| :------ | :------ |
| `level` | `number` |
| `voxel` | [`Coords3`](modules.md#coords3-404) |
...
| `perspective` | [`CameraPerspective`](modules.md#cameraperspective-404) | The position of where the camera should be looking at. Defaults to `pxyz`, which means that the camera will be looking at the center of the object from the positive x, y, and z axis scaled by the zoom. |
...
| `initialPosition` | [`Coords3`](modules.md#coords3-404) | Initial position of the client. Defaults to `(0, 80, 10)`. |
...
| `cloudsOptions` | `Partial`\<[`CloudsOptions`](modules.md#cloudsoptions-404)\> | The options to create the clouds. Defaults to `{}`. |
...
| `skyOptions` | `Partial`\<[`SkyOptions`](modules.md#skyoptions-404)\> | The options to create the sky. Defaults to `{}`. |
...
Ƭ **WorldOptions**: [`WorldClientOptions`](modules.md#worldclientoptions-404) & [`WorldServerOptions`](modules.md#worldserveroptions-404)

The options to create a world. This consists of [WorldClientOptions](modules.md#worldclientoptions-404) and [WorldServerOptions](modules.md#worldserveroptions-404).
...
• `Const` **BOX\_SIDES**: [`BoxSides`](modules.md#boxsides-404)[]
...
| Name | Type |
| :------ | :------ |
| `drawCrown` | [`ArtFunction`](modules.md#artfunction-404) |
...
▸ **cull**(`array`, `options`): `Promise`\<[`MeshResultType`](modules.md#meshresulttype-404)\>
...
| `options` | [`CullOptionsType`](modules.md#culloptionstype-404) |

#### Returns

`Promise`\<[`MeshResultType`](modules.md#meshresulttype-404)\>
