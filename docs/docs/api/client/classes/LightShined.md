...
| `options` | `Partial`\<[`LightShinedOptions`](../modules.md#lightshinedoptions-168)\> | Parameters to customize the effect. |
...
• **options**: [`LightShinedOptions`](../modules.md#lightshinedoptions-168)
