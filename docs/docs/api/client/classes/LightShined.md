...
| `params` | `Partial`<[`LightShinedParams`](../modules.md#lightshinedparams-96)\> | Parameters to customize the effect. |
...
• **params**: [`LightShinedParams`](../modules.md#lightshinedparams-96)
