...
| `options` | `Partial`\<[`LightShinedOptions`](../modules.md#lightshinedoptions-232)\> | Parameters to customize the effect. |
...
• **options**: [`LightShinedOptions`](../modules.md#lightshinedoptions-232)
