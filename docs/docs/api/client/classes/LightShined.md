...
| `options` | `Partial`\<[`LightShinedOptions`](../modules.md#lightshinedoptions-404)\> | Parameters to customize the effect. |
...
• **options**: [`LightShinedOptions`](../modules.md#lightshinedoptions-404)
