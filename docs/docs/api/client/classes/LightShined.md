...
| `options` | `Partial`\<[`LightShinedOptions`](../modules.md#lightshinedoptions-32)\> | Parameters to customize the effect. |
...
• **options**: [`LightShinedOptions`](../modules.md#lightshinedoptions-32)
