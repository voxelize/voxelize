...
| `options` | `Partial`\<[`LightShinedOptions`](../modules.md#lightshinedoptions-30)\> | Parameters to customize the effect. |
...
• **options**: [`LightShinedOptions`](../modules.md#lightshinedoptions-30)
