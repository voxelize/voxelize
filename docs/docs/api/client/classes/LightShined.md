...
| `options` | `Partial`<[`LightShinedOptions`](../modules.md#lightshinedoptions-6)\> | Parameters to customize the effect. |
...
• **options**: [`LightShinedOptions`](../modules.md#lightshinedoptions-6)
