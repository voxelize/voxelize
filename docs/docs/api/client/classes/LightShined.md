...
| `params` | `Partial`<[`LightShinedParams`](../modules.md#lightshinedparams-114)\> | Parameters to customize the effect. |
...
• **params**: [`LightShinedParams`](../modules.md#lightshinedparams-114)
