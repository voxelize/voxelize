...
| `options` | `Partial`\<[`LightShinedOptions`](../modules.md#lightshinedoptions-124)\> | Parameters to customize the effect. |
...
• **options**: [`LightShinedOptions`](../modules.md#lightshinedoptions-124)
