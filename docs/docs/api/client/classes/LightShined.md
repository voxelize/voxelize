...
| `options` | `Partial`\<[`LightShinedOptions`](../modules.md#lightshinedoptions-154)\> | Parameters to customize the effect. |
...
• **options**: [`LightShinedOptions`](../modules.md#lightshinedoptions-154)
