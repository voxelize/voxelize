...
| Name | Type | Description |
| :------ | :------ | :------ |
| `side` | [`BoxSides`](../modules.md#boxsides-96) \| [`BoxSides`](../modules.md#boxsides-96)[] | The side(s) of the box layer to draw on. |
| `art` | `Texture` \| `Color` \| [`ArtFunction`](../modules.md#artfunction-96) | The art or art function to draw on the box layer's side. |
