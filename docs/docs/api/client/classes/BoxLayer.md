...
| Name | Type | Description |
| :------ | :------ | :------ |
| `side` | [`BoxSides`](../modules.md#boxsides-6) \| [`BoxSides`](../modules.md#boxsides-6)[] | The side(s) of the box layer to draw on. |
| `art` | `Texture` \| [`ArtFunction`](../modules.md#artfunction-6) \| `Color` | The art or art function to draw on the box layer's side. |
