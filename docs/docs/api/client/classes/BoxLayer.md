...
| Name | Type | Description |
| :------ | :------ | :------ |
| `side` | [`BoxSides`](../modules.md#boxsides-24) \| [`BoxSides`](../modules.md#boxsides-24)[] | The side(s) of the box layer to draw on. |
| `art` | `Color` \| `Texture` \| [`ArtFunction`](../modules.md#artfunction-24) | The art or art function to draw on the box layer's side. |
