...
| Name | Type |
| :------ | :------ |
| `options` | `Partial`\<[`SkyOptions`](../modules.md#skyoptions-30)\> |
...
[CanvasBox](CanvasBox.md).[constructor](CanvasBox.md#constructor-30)
...
[CanvasBox](CanvasBox.md).[boxLayers](CanvasBox.md#boxlayers-30)
...
[CanvasBox](CanvasBox.md).[depth](CanvasBox.md#depth-30)
...
[CanvasBox](CanvasBox.md).[height](CanvasBox.md#height-30)

___

### options

• **options**: [`CanvasBoxOptions`](../modules.md#canvasboxoptions-30) & [`SkyOptions`](../modules.md#skyoptions-30)

Parameters for creating a canvas box.

#### Overrides

[CanvasBox](CanvasBox.md).[options](CanvasBox.md#options-30)

___

### shadingData

• **shadingData**: [`SkyShadingCycleData`](../modules.md#skyshadingcycledata-30)[] = `[]`
...
[CanvasBox](CanvasBox.md).[width](CanvasBox.md#width-30)
...
| :------ | :------ | :------ | :------ |
| `side` | [`BoxSides`](../modules.md#boxsides-30) \| [`BoxSides`](../modules.md#boxsides-30)[] | `undefined` | The side(s) of the box layer to draw on. |
| `art` | `Color` \| `Texture` \| [`ArtFunction`](../modules.md#artfunction-30) | `undefined` | The art or art function to draw on the box layer's side. |
...
[CanvasBox](CanvasBox.md).[paint](CanvasBox.md#paint-30)
...
| Name | Type |
| :------ | :------ |
| `data` | [`SkyShadingCycleData`](../modules.md#skyshadingcycledata-30)[] |
