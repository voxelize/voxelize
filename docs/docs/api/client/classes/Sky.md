...
| Name | Type |
| :------ | :------ |
| `options` | `Partial`\<[`SkyOptions`](../modules.md#skyoptions-4)\> |
...
• **options**: [`CanvasBoxOptions`](../modules.md#canvasboxoptions-4) & [`SkyOptions`](../modules.md#skyoptions-4)

Parameters for creating a canvas box.

#### Overrides

[CanvasBox](CanvasBox.md).[options](CanvasBox.md#options-4)

___

### shadingData

• **shadingData**: [`SkyShadingCycleData`](../modules.md#skyshadingcycledata-4)[] = `[]`
...
| `art` | `Color` \| `Texture` \| [`ArtFunction`](../modules.md#artfunction-4) | `undefined` | The art or art function to draw on the box layer's side. |
...
| Name | Type |
| :------ | :------ |
| `data` | [`SkyShadingCycleData`](../modules.md#skyshadingcycledata-4)[] |
