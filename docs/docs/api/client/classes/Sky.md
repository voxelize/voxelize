...
| Name | Type |
| :------ | :------ |
| `options` | `Partial`\<[`SkyOptions`](../modules.md#skyoptions-32)\> |
...
[CanvasBox](CanvasBox.md).[constructor](CanvasBox.md#constructor-32)
...
[CanvasBox](CanvasBox.md).[boxLayers](CanvasBox.md#boxlayers-32)
...
[CanvasBox](CanvasBox.md).[depth](CanvasBox.md#depth-32)
...
[CanvasBox](CanvasBox.md).[height](CanvasBox.md#height-32)

___

### options

• **options**: [`CanvasBoxOptions`](../modules.md#canvasboxoptions-32) & [`SkyOptions`](../modules.md#skyoptions-32)

Parameters for creating a canvas box.

#### Overrides

[CanvasBox](CanvasBox.md).[options](CanvasBox.md#options-32)

___

### shadingData

• **shadingData**: [`SkyShadingCycleData`](../modules.md#skyshadingcycledata-32)[] = `[]`
...
[CanvasBox](CanvasBox.md).[width](CanvasBox.md#width-32)
...
| :------ | :------ | :------ | :------ |
| `side` | [`BoxSides`](../modules.md#boxsides-32) \| [`BoxSides`](../modules.md#boxsides-32)[] | `undefined` | The side(s) of the box layer to draw on. |
| `art` | `Color` \| `Texture` \| [`ArtFunction`](../modules.md#artfunction-32) | `undefined` | The art or art function to draw on the box layer's side. |
...
[CanvasBox](CanvasBox.md).[paint](CanvasBox.md#paint-32)
...
| Name | Type |
| :------ | :------ |
| `data` | [`SkyShadingCycleData`](../modules.md#skyshadingcycledata-32)[] |
