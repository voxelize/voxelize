...
• **new BlockBreakParticles**(`world`, `options?`)
...
| `options` | `Partial`<[`BlockBreakParticlesOptions`](../modules.md#blockbreakparticlesoptions-114)\> | Parameters to create a block break particle system. |
