...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`CanvasBoxOptions`](../modules.md#canvasboxoptions-124)\> | The options for creating a canvas box. |
...
• **options**: [`CanvasBoxOptions`](../modules.md#canvasboxoptions-124)
