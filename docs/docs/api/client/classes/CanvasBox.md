...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`CanvasBoxOptions`](../modules.md#canvasboxoptions-232)\> | The options for creating a canvas box. |
...
• **options**: [`CanvasBoxOptions`](../modules.md#canvasboxoptions-232)
