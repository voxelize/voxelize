...
• **options**: [`CanvasBoxOptions`](../modules.md#canvasboxoptions-6)
...
| :------ | :------ | :------ |
| `options` | `Partial`<[`CanvasBoxOptions`](../modules.md#canvasboxoptions-6)\> | The options for creating a canvas box. |
