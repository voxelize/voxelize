...
| `options` | `Partial`\<[`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-124)\> | The options to initialize the controls with. |
...
[RigidControls](RigidControls.md).[constructor](RigidControls.md#constructor-124)
...
when [RigidControls.connect](RigidControls.md#connect-124) is called.

#### Inherited from

[RigidControls](RigidControls.md).[INPUT_IDENTIFIER](RigidControls.md#input_identifier-124)
...
calling [RigidControls.attachArm](RigidControls.md#attacharm-124) to add a mesh for the first person
view.

#### Inherited from

[RigidControls](RigidControls.md).[arm](RigidControls.md#arm-124)
...
[RigidControls](RigidControls.md).[body](RigidControls.md#body-124)
...
[RigidControls](RigidControls.md).[camera](RigidControls.md#camera-124)
...
calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-124) to add a mesh for 2nd and 3rd person
view.

#### Inherited from

[RigidControls](RigidControls.md).[character](RigidControls.md#character-124)
...
[RigidControls](RigidControls.md).[domElement](RigidControls.md#domelement-124)
...
[RigidControls.connect](RigidControls.md#connect-124), which registers the keyboard inputs for the controls.

#### Inherited from

[RigidControls](RigidControls.md).[inputs](RigidControls.md#inputs-124)
...
[RigidControls](RigidControls.md).[isLocked](RigidControls.md#islocked-124)
...
[RigidControls](RigidControls.md).[movements](RigidControls.md#movements-124)
...
[RigidControls](RigidControls.md).[object](RigidControls.md#object-124)

___

### options

• **options**: [`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-124)

Parameters to initialize the Voxelize controls.

#### Inherited from

[RigidControls](RigidControls.md).[options](RigidControls.md#options-124)
...
[RigidControls](RigidControls.md).[ownID](RigidControls.md#ownid-124)

___

### state

• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-124)

The state of the control, indicating things like whether or not the client is running.

#### Inherited from

[RigidControls](RigidControls.md).[state](RigidControls.md#state-124)
...
[RigidControls](RigidControls.md).[world](RigidControls.md#world-124)

## Accessors

### chunk

• `get` **chunk**(): [`Coords2`](../modules.md#coords2-124)

The chunk that the client is situated in.

#### Returns

[`Coords2`](../modules.md#coords2-124)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-124)
...
[`Coords3`](../modules.md#coords3-124)
...
[RigidControls](RigidControls.md).[attachArm](RigidControls.md#attacharm-124)
...
[RigidControls](RigidControls.md).[attachCharacter](RigidControls.md#attachcharacter-124)
...
Keep in mind that if [Inputs.remap](Inputs.md#remap-124) is used to remap any controls, they will
...
[RigidControls](RigidControls.md).[connect](RigidControls.md#connect-124)
...
[RigidControls](RigidControls.md).[getDirection](RigidControls.md#getdirection-124)
...
[RigidControls](RigidControls.md).[lock](RigidControls.md#lock-124)
...
[RigidControls](RigidControls.md).[lookAt](RigidControls.md#lookat-124)
...
[RigidControls](RigidControls.md).[moveForward](RigidControls.md#moveforward-124)
...
[RigidControls](RigidControls.md).[moveRight](RigidControls.md#moveright-124)
...
[RigidControls](RigidControls.md).[on](RigidControls.md#on-124)
...
[RigidControls](RigidControls.md).[onMessage](RigidControls.md#onmessage-124)
...
[RigidControls](RigidControls.md).[reset](RigidControls.md#reset-124)
...
[RigidControls](RigidControls.md).[resetMovements](RigidControls.md#resetmovements-124)
...
[RigidControls](RigidControls.md).[teleport](RigidControls.md#teleport-124)
...
[RigidControls](RigidControls.md).[teleportToTop](RigidControls.md#teleporttotop-124)
...
[RigidControls](RigidControls.md).[toggleFly](RigidControls.md#togglefly-124)
...
[RigidControls](RigidControls.md).[toggleGhostMode](RigidControls.md#toggleghostmode-124)
...
[RigidControls](RigidControls.md).[unlock](RigidControls.md#unlock-124)
...
[RigidControls](RigidControls.md).[update](RigidControls.md#update-124)
