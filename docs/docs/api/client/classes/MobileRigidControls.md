...
| `options` | `Partial`\<[`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-168)\> | The options to initialize the controls with. |
...
[RigidControls](RigidControls.md).[constructor](RigidControls.md#constructor-168)
...
when [RigidControls.connect](RigidControls.md#connect-168) is called.

#### Inherited from

[RigidControls](RigidControls.md).[INPUT_IDENTIFIER](RigidControls.md#input_identifier-168)
...
calling [RigidControls.attachArm](RigidControls.md#attacharm-168) to add a mesh for the first person
view.

#### Inherited from

[RigidControls](RigidControls.md).[arm](RigidControls.md#arm-168)
...
[RigidControls](RigidControls.md).[body](RigidControls.md#body-168)
...
[RigidControls](RigidControls.md).[camera](RigidControls.md#camera-168)
...
calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-168) to add a mesh for 2nd and 3rd person
view.

#### Inherited from

[RigidControls](RigidControls.md).[character](RigidControls.md#character-168)
...
[RigidControls](RigidControls.md).[domElement](RigidControls.md#domelement-168)
...
[RigidControls.connect](RigidControls.md#connect-168), which registers the keyboard inputs for the controls.

#### Inherited from

[RigidControls](RigidControls.md).[inputs](RigidControls.md#inputs-168)
...
[RigidControls](RigidControls.md).[isLocked](RigidControls.md#islocked-168)
...
[RigidControls](RigidControls.md).[movements](RigidControls.md#movements-168)
...
[RigidControls](RigidControls.md).[object](RigidControls.md#object-168)

___

### options

• **options**: [`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-168)

Parameters to initialize the Voxelize controls.

#### Inherited from

[RigidControls](RigidControls.md).[options](RigidControls.md#options-168)
...
[RigidControls](RigidControls.md).[ownID](RigidControls.md#ownid-168)

___

### state

• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-168)

The state of the control, indicating things like whether or not the client is running.

#### Inherited from

[RigidControls](RigidControls.md).[state](RigidControls.md#state-168)
...
[RigidControls](RigidControls.md).[world](RigidControls.md#world-168)

## Accessors

### chunk

• `get` **chunk**(): [`Coords2`](../modules.md#coords2-168)

The chunk that the client is situated in.

#### Returns

[`Coords2`](../modules.md#coords2-168)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-168)
...
[`Coords3`](../modules.md#coords3-168)
...
[RigidControls](RigidControls.md).[attachArm](RigidControls.md#attacharm-168)
...
[RigidControls](RigidControls.md).[attachCharacter](RigidControls.md#attachcharacter-168)
...
Keep in mind that if [Inputs.remap](Inputs.md#remap-168) is used to remap any controls, they will
...
[RigidControls](RigidControls.md).[connect](RigidControls.md#connect-168)
...
[RigidControls](RigidControls.md).[getDirection](RigidControls.md#getdirection-168)
...
[RigidControls](RigidControls.md).[lock](RigidControls.md#lock-168)
...
[RigidControls](RigidControls.md).[lookAt](RigidControls.md#lookat-168)
...
[RigidControls](RigidControls.md).[moveForward](RigidControls.md#moveforward-168)
...
[RigidControls](RigidControls.md).[moveRight](RigidControls.md#moveright-168)
...
[RigidControls](RigidControls.md).[on](RigidControls.md#on-168)
...
[RigidControls](RigidControls.md).[onMessage](RigidControls.md#onmessage-168)
...
[RigidControls](RigidControls.md).[reset](RigidControls.md#reset-168)
...
[RigidControls](RigidControls.md).[resetMovements](RigidControls.md#resetmovements-168)
...
[RigidControls](RigidControls.md).[teleport](RigidControls.md#teleport-168)
...
[RigidControls](RigidControls.md).[teleportToTop](RigidControls.md#teleporttotop-168)
...
[RigidControls](RigidControls.md).[toggleFly](RigidControls.md#togglefly-168)
...
[RigidControls](RigidControls.md).[toggleGhostMode](RigidControls.md#toggleghostmode-168)
...
[RigidControls](RigidControls.md).[unlock](RigidControls.md#unlock-168)
...
[RigidControls](RigidControls.md).[update](RigidControls.md#update-168)
