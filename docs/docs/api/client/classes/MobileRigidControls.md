...
| `options` | `Partial`\<[`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-154)\> | The options to initialize the controls with. |
...
[RigidControls](RigidControls.md).[constructor](RigidControls.md#constructor-154)
...
when [RigidControls.connect](RigidControls.md#connect-154) is called.

#### Inherited from

[RigidControls](RigidControls.md).[INPUT_IDENTIFIER](RigidControls.md#input_identifier-154)
...
calling [RigidControls.attachArm](RigidControls.md#attacharm-154) to add a mesh for the first person
view.

#### Inherited from

[RigidControls](RigidControls.md).[arm](RigidControls.md#arm-154)
...
[RigidControls](RigidControls.md).[body](RigidControls.md#body-154)
...
[RigidControls](RigidControls.md).[camera](RigidControls.md#camera-154)
...
calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-154) to add a mesh for 2nd and 3rd person
view.

#### Inherited from

[RigidControls](RigidControls.md).[character](RigidControls.md#character-154)
...
[RigidControls](RigidControls.md).[domElement](RigidControls.md#domelement-154)
...
[RigidControls.connect](RigidControls.md#connect-154), which registers the keyboard inputs for the controls.

#### Inherited from

[RigidControls](RigidControls.md).[inputs](RigidControls.md#inputs-154)
...
[RigidControls](RigidControls.md).[isLocked](RigidControls.md#islocked-154)
...
[RigidControls](RigidControls.md).[movements](RigidControls.md#movements-154)
...
[RigidControls](RigidControls.md).[object](RigidControls.md#object-154)

___

### options

• **options**: [`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-154)

Parameters to initialize the Voxelize controls.

#### Inherited from

[RigidControls](RigidControls.md).[options](RigidControls.md#options-154)
...
[RigidControls](RigidControls.md).[ownID](RigidControls.md#ownid-154)

___

### state

• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-154)

The state of the control, indicating things like whether or not the client is running.

#### Inherited from

[RigidControls](RigidControls.md).[state](RigidControls.md#state-154)
...
[RigidControls](RigidControls.md).[world](RigidControls.md#world-154)

## Accessors

### chunk

• `get` **chunk**(): [`Coords2`](../modules.md#coords2-154)

The chunk that the client is situated in.

#### Returns

[`Coords2`](../modules.md#coords2-154)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-154)
...
[`Coords3`](../modules.md#coords3-154)
...
[RigidControls](RigidControls.md).[attachArm](RigidControls.md#attacharm-154)
...
[RigidControls](RigidControls.md).[attachCharacter](RigidControls.md#attachcharacter-154)
...
Keep in mind that if [Inputs.remap](Inputs.md#remap-154) is used to remap any controls, they will
...
[RigidControls](RigidControls.md).[connect](RigidControls.md#connect-154)
...
[RigidControls](RigidControls.md).[getDirection](RigidControls.md#getdirection-154)
...
[RigidControls](RigidControls.md).[lock](RigidControls.md#lock-154)
...
[RigidControls](RigidControls.md).[lookAt](RigidControls.md#lookat-154)
...
[RigidControls](RigidControls.md).[moveForward](RigidControls.md#moveforward-154)
...
[RigidControls](RigidControls.md).[moveRight](RigidControls.md#moveright-154)
...
[RigidControls](RigidControls.md).[on](RigidControls.md#on-154)
...
[RigidControls](RigidControls.md).[onMessage](RigidControls.md#onmessage-154)
...
[RigidControls](RigidControls.md).[reset](RigidControls.md#reset-154)
...
[RigidControls](RigidControls.md).[resetMovements](RigidControls.md#resetmovements-154)
...
[RigidControls](RigidControls.md).[teleport](RigidControls.md#teleport-154)
...
[RigidControls](RigidControls.md).[teleportToTop](RigidControls.md#teleporttotop-154)
...
[RigidControls](RigidControls.md).[toggleFly](RigidControls.md#togglefly-154)
...
[RigidControls](RigidControls.md).[toggleGhostMode](RigidControls.md#toggleghostmode-154)
...
[RigidControls](RigidControls.md).[unlock](RigidControls.md#unlock-154)
...
[RigidControls](RigidControls.md).[update](RigidControls.md#update-154)
