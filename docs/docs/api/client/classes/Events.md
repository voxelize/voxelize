...
- `Map`\<`string`, [`EventHandler`](../modules.md#eventhandler-124)\>
...
Synonym for [on](Events.md#on-124), adds a listener to a Voxelize server event.
...
| `handler` | [`EventHandler`](../modules.md#eventhandler-124) | What to do when this event is received? |
...
Synonym for [addEventListener](Events.md#addeventlistener-124), adds a listener to a Voxelize server event.
If the payload cannot be parsed by JSON, `null` is set.
