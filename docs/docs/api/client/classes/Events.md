...
- `Map`\<`string`, [`EventHandler`](../modules.md#eventhandler-154)\>
...
Synonym for [on](Events.md#on-154), adds a listener to a Voxelize server event.
...
| `handler` | [`EventHandler`](../modules.md#eventhandler-154) | What to do when this event is received? |
...
Synonym for [addEventListener](Events.md#addeventlistener-154), adds a listener to a Voxelize server event.
If the payload cannot be parsed by JSON, `null` is set.
