...
- `Map`\<`string`, [`EventHandler`](../modules.md#eventhandler-404)\>
...
Synonym for [on](Events.md#on-404), adds a listener to a Voxelize server event.
...
| `handler` | [`EventHandler`](../modules.md#eventhandler-404) | What to do when this event is received? |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `events` | [`Event`](../modules.md#event-404)[] | A list of events to emit. |
...
Synonym for [addEventListener](Events.md#addeventlistener-404), adds a listener to a Voxelize server event.
If the payload cannot be parsed by JSON, `null` is set.
