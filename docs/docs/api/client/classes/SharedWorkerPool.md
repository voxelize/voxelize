...
| `options` | [`SharedWorkerPoolOptions`](../modules.md#sharedworkerpooloptions-4) | `defaultOptions` | The options to create the worker pool. |
...
• **options**: [`SharedWorkerPoolOptions`](../modules.md#sharedworkerpooloptions-4) = `defaultOptions`
...
• **queue**: [`SharedWorkerPoolJob`](../modules.md#sharedworkerpooljob-4)[] = `[]`
...
| :------ | :------ | :------ |
| `job` | [`SharedWorkerPoolJob`](../modules.md#sharedworkerpooljob-4) | The job to queue. |
