...
| `options` | [`SharedWorkerPoolOptions`](../modules.md#sharedworkerpooloptions-30) | `defaultOptions` | The options to create the worker pool. |
...
• **options**: [`SharedWorkerPoolOptions`](../modules.md#sharedworkerpooloptions-30) = `defaultOptions`
...
• **queue**: [`SharedWorkerPoolJob`](../modules.md#sharedworkerpooljob-30)[] = `[]`
...
| :------ | :------ | :------ |
| `job` | [`SharedWorkerPoolJob`](../modules.md#sharedworkerpooljob-30) | The job to queue. |
