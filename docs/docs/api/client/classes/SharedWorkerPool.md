...
| `options` | [`SharedWorkerPoolOptions`](../modules.md#sharedworkerpooloptions-166) | `defaultOptions` | The options to create the worker pool. |
...
• **options**: [`SharedWorkerPoolOptions`](../modules.md#sharedworkerpooloptions-166) = `defaultOptions`
...
• **queue**: [`SharedWorkerPoolJob`](../modules.md#sharedworkerpooljob-166)[] = `[]`
...
| :------ | :------ | :------ |
| `job` | [`SharedWorkerPoolJob`](../modules.md#sharedworkerpooljob-166) | The job to queue. |
