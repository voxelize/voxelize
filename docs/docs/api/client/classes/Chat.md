...
| `process` | [`CommandProcessor`](../modules.md#commandprocessor-30) | The process run when this command is triggered. |
| `options` | [`CommandOptions`](../modules.md#commandoptions-30) | Optional configuration for the command (description, category, aliases). |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `fallback` | [`CommandProcessor`](../modules.md#commandprocessor-30) | The fallback command processor. |
