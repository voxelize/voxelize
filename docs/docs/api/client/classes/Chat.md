...
| `process` | [`CommandProcessor`](../modules.md#commandprocessor-4) | The process run when this command is triggered. |
| `options` | [`CommandOptions`](../modules.md#commandoptions-4) | Optional configuration for the command (description, category, aliases). |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `fallback` | [`CommandProcessor`](../modules.md#commandprocessor-4) | The fallback command processor. |
