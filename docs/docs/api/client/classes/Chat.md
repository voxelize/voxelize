...
| `process` | [`CommandProcessor`](../modules.md#commandprocessor-32) | The process run when this command is triggered. |
| `options` | [`CommandOptions`](../modules.md#commandoptions-32) | Optional configuration for the command (description, category, aliases). |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `fallback` | [`CommandProcessor`](../modules.md#commandprocessor-32) | The fallback command processor. |
