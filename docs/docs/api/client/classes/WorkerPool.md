...
| `options` | [`WorkerPoolOptions`](../modules.md#workerpooloptions-30) | `defaultOptions` | The options to create the worker pool. |
...
• **options**: [`WorkerPoolOptions`](../modules.md#workerpooloptions-30) = `defaultOptions`
...
• **queue**: [`WorkerPoolJob`](../modules.md#workerpooljob-30)[] = `[]`
...
| :------ | :------ | :------ |
| `job` | [`WorkerPoolJob`](../modules.md#workerpooljob-30) | The job to queue. |
