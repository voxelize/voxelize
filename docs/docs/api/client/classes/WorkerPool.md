...
• **options**: [`WorkerPoolOptions`](../modules.md#workerpooloptions-14) = `defaultOptions`
...
| `options` | [`WorkerPoolOptions`](../modules.md#workerpooloptions-14) | `defaultOptions` | The options to create the worker pool. |
