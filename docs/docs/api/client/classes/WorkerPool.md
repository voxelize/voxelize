...
| `options` | [`WorkerPoolOptions`](../modules.md#workerpooloptions-32) | `defaultOptions` | The options to create the worker pool. |
...
• **options**: [`WorkerPoolOptions`](../modules.md#workerpooloptions-32) = `defaultOptions`
...
• **queue**: [`WorkerPoolJob`](../modules.md#workerpooljob-32)[] = `[]`
...
| :------ | :------ | :------ |
| `job` | [`WorkerPoolJob`](../modules.md#workerpooljob-32) | The job to queue. |
