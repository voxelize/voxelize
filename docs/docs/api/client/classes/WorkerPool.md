...
• **params**: [`WorkerPoolParams`](../modules.md#workerpoolparams-96) = `defaultParams`
...
• **queue**: [`WorkerPoolJob`](../modules.md#workerpooljob-96)[] = `[]`
...
| :------ | :------ | :------ |
| `job` | [`WorkerPoolJob`](../modules.md#workerpooljob-96) | The job to queue. |
...
| `params` | [`WorkerPoolParams`](../modules.md#workerpoolparams-96) | `defaultParams` | The parameters to create the worker pool. |
