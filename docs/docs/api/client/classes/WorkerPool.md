...
| `options` | [`WorkerPoolOptions`](../modules.md#workerpooloptions-124) | `defaultOptions` | The options to create the worker pool. |
...
• **options**: [`WorkerPoolOptions`](../modules.md#workerpooloptions-124) = `defaultOptions`
...
• **queue**: [`WorkerPoolJob`](../modules.md#workerpooljob-124)[] = `[]`
...
| :------ | :------ | :------ |
| `job` | [`WorkerPoolJob`](../modules.md#workerpooljob-124) | The job to queue. |
