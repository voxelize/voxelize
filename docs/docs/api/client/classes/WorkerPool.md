...
• **params**: [`WorkerPoolParams`](../modules.md#workerpoolparams-38) = `defaultParams`
...
• **queue**: [`WorkerPoolJob`](../modules.md#workerpooljob-38)[] = `[]`
...
| :------ | :------ | :------ |
| `job` | [`WorkerPoolJob`](../modules.md#workerpooljob-38) | The job to queue. |
...
| `params` | [`WorkerPoolParams`](../modules.md#workerpoolparams-38) | `defaultParams` | The parameters to create the worker pool. |
