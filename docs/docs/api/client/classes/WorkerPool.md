...
| `options` | [`WorkerPoolOptions`](../modules.md#workerpooloptions-8) | `defaultOptions` | The options to create the worker pool. |
...
• **options**: [`WorkerPoolOptions`](../modules.md#workerpooloptions-8) = `defaultOptions`
