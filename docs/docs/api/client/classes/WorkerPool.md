...
• **params**: [`WorkerPoolParams`](../modules.md#workerpoolparams-114) = `defaultParams`
...
• **queue**: [`WorkerPoolJob`](../modules.md#workerpooljob-114)[] = `[]`
...
| :------ | :------ | :------ |
| `job` | [`WorkerPoolJob`](../modules.md#workerpooljob-114) | The job to queue. |
...
| `params` | [`WorkerPoolParams`](../modules.md#workerpoolparams-114) | `defaultParams` | The parameters to create the worker pool. |
