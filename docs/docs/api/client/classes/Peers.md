...
Override [Peers.packInfo](Peers.md#packinfo-8) to customize the information that is sent to other peers.
...
A function called when a player joins the game. By default, the function calls the [Peers.createPeer](Peers.md#createpeer-8)
