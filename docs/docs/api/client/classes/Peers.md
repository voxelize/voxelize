...
Override [Peers.packInfo](Peers.md#packinfo-124) to customize the information that is sent to other peers.
...
| `options` | `Partial`\<[`PeersOptions`](../modules.md#peersoptions-124)\> | Parameters to customize the effect. |
...
A function called when a player joins the game. By default, the function calls the [Peers.createPeer](Peers.md#createpeer-124)
...
• **options**: [`PeersOptions`](../modules.md#peersoptions-124)
