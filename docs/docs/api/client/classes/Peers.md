...
Override [packInfo](Peers.md#packinfo-6) to customize the information that is sent to other peers.
...
| `params` | `Partial`<[`PeersParams`](../modules.md#peersparams-6)\> | Parameters to customize the effect. |
...
• **params**: [`PeersParams`](../modules.md#peersparams-6)
...
should not be overridden unless you know what you are doing. Internally, this calls [createPeer](Peers.md#createpeer-6)
