...
Override [packInfo](Peers.md#packinfo-2) to customize the information that is sent to other peers.
...
| `options` | `Partial`<[`PeersOptions`](../modules.md#peersoptions-2)\> | Parameters to customize the effect. |
...
A function called when a player joins the game. By default, the function calls the [createPeer](Peers.md#createpeer-2)
...
• **options**: [`PeersOptions`](../modules.md#peersoptions-2)
...
The peer object that represents the client themselves. This is set when you call [setOwnPeer](Peers.md#setownpeer-2).
