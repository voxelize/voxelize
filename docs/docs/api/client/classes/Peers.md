...
Override [Peers.packInfo](Peers.md#packinfo-232) to customize the information that is sent to other peers.
...
| `options` | `Partial`\<[`PeersOptions`](../modules.md#peersoptions-232)\> | Parameters to customize the effect. |
...
A function called when a player joins the game. By default, the function calls the [Peers.createPeer](Peers.md#createpeer-232)
...
• **options**: [`PeersOptions`](../modules.md#peersoptions-232)
