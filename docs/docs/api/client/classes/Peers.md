...
Override [Peers.packInfo](Peers.md#packinfo-406) to customize the information that is sent to other peers.
...
| `options` | `Partial`\<[`PeersOptions`](../modules.md#peersoptions-406)\> | Parameters to customize the effect. |
...
A function called when a player joins the game. By default, the function calls the [Peers.createPeer](Peers.md#createpeer-406)
...
• **options**: [`PeersOptions`](../modules.md#peersoptions-406)
