...
Override [Peers.packInfo](Peers.md#packinfo-154) to customize the information that is sent to other peers.
...
| `options` | `Partial`\<[`PeersOptions`](../modules.md#peersoptions-154)\> | Parameters to customize the effect. |
...
A function called when a player joins the game. By default, the function calls the [Peers.createPeer](Peers.md#createpeer-154)
...
• **options**: [`PeersOptions`](../modules.md#peersoptions-154)
