...
Registry is by default created by the world and is available as [registry](World.md#registry-6).
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-6)[] | A list of blocks received from the server. |
...
• **blocksById**: `Map`<`number`, [`Block`](../modules.md#block-6)\>
...
• **blocksByName**: `Map`<`string`, [`Block`](../modules.md#block-6)\>
...
• **ranges**: `Map`<`string`, [`TextureRange`](../modules.md#texturerange-6)\>
