...
Registry is by default created by the world and is available as [registry](World.md#registry-114).
...
| :------ | :------ | :------ |
| `texture` | [`TextureData`](../modules.md#texturedata-114) | The data of the texture and where the texture is applying to. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-114)[] | A list of blocks received from the server. |
...
• **blocksById**: `Map`<`number`, [`Block`](../modules.md#block-114)\>
...
• **blocksByName**: `Map`<`string`, [`Block`](../modules.md#block-114)\>
