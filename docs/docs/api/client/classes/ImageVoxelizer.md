...
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-96) | The extra parameters to process the image voxelization. |
...
| Name | Type |
| :------ | :------ |
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-96) |
| `url` | `string` |
