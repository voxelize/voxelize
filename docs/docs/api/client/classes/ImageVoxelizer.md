...
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-6) | The extra parameters to process the image voxelization. |
...
| Name | Type |
| :------ | :------ |
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-6) |
| `url` | `string` |
