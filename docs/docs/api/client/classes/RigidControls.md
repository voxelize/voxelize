...
Keep in mind that by calling [attachCharacter](RigidControls.md#attachcharacter-4), the body is
...
Keep in mind that if [remap](Inputs.md#remap-4) is used to remap any controls, they will
