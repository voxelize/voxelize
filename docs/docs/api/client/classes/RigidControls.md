...
when [connect](RigidControls.md#connect-18) is called.
...
Keep in mind that by calling [attachCharacter](RigidControls.md#attachcharacter-18), the body is
...
calling [attachCharacter](RigidControls.md#attachcharacter-18) to add a mesh for 2nd and 3rd person
view.
...
[connect](RigidControls.md#connect-18), which registers the keyboard inputs for the controls.
...
• **options**: [`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-6)
...
• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-18)
...
Keep in mind that if [remap](Inputs.md#remap-18) is used to remap any controls, they will
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-18)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-18)
...
| `options` | `Partial`<[`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-6)\> | The options to initialize the controls with. |
