...
when [connect](RigidControls.md#connect-38) is called.
...
Keep in mind that by calling [attachCharacter](RigidControls.md#attachcharacter-38), the body is
...
calling [attachCharacter](RigidControls.md#attachcharacter-38) to add a mesh for 2nd and 3rd person
view.
...
[connect](RigidControls.md#connect-38), which registers the keyboard inputs for the controls.
...
• **params**: [`RigidControlsParams`](../modules.md#rigidcontrolsparams-38)
...
• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-38)
...
Keep in mind that if [remap](Inputs.md#remap-38) is used to remap any controls, they will
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-38)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-38)
...
| `options` | `Partial`<[`RigidControlsParams`](../modules.md#rigidcontrolsparams-38)\> | The options to initialize the controls with. |
