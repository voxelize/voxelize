...
| `options` | `Partial`\<[`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-406)\> | The options to initialize the controls with. |
...
when [RigidControls.connect](RigidControls.md#connect-406) is called.
...
calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-406) to add a mesh for 2nd and 3rd person
view.
...
[RigidControls.connect](RigidControls.md#connect-406), which registers the keyboard inputs for the controls.
...
• **options**: [`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-406)
...
• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-406)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-406)

The chunk that the client is situated in.

#### Returns

[`Coords2`](../modules.md#coords2-406)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-406)
...
[`Coords3`](../modules.md#coords3-406)
...
Keep in mind that if [Inputs.remap](Inputs.md#remap-406) is used to remap any controls, they will
...
[NetIntercept](../interfaces/NetIntercept.md).[onMessage](../interfaces/NetIntercept.md#onmessage-406)
