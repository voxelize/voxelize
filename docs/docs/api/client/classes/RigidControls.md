...
| `options` | `Partial`\<[`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-166)\> | The options to initialize the controls with. |
...
when [RigidControls.connect](RigidControls.md#connect-166) is called.
...
calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-166) to add a mesh for 2nd and 3rd person
view.
...
[RigidControls.connect](RigidControls.md#connect-166), which registers the keyboard inputs for the controls.
...
• **options**: [`RigidControlsOptions`](../modules.md#rigidcontrolsoptions-166)
...
• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-166)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-166)

The chunk that the client is situated in.

#### Returns

[`Coords2`](../modules.md#coords2-166)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-166)
...
[`Coords3`](../modules.md#coords3-166)
...
Keep in mind that if [Inputs.remap](Inputs.md#remap-166) is used to remap any controls, they will
...
[NetIntercept](../interfaces/NetIntercept.md).[onMessage](../interfaces/NetIntercept.md#onmessage-166)
