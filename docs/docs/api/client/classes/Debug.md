...
| `params` | `Partial`<[`DebugParams`](../modules.md#debugparams-6)\> | `{}` | Parameters to create a [Debug](Debug.md) instance. |
...
• **params**: [`DebugParams`](../modules.md#debugparams-6)
...
Register a new object attribute to track. Needs to call [update](Debug.md#update-6) in the game loop
to update the value.
