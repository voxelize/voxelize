...
| `options` | `Partial`\<[`DebugOptions`](../modules.md#debugoptions-166)\> | `{}` | Parameters to create a [Debug](Debug.md) instance. |
...
• **options**: [`DebugOptions`](../modules.md#debugoptions-166)
...
Register a new object attribute to track. Needs to call [Debug.update](Debug.md#update-166) in the game loop
to update the value.
