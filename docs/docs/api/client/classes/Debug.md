...
| `options` | `Partial`<[`DebugOptions`](../modules.md#debugoptions-6)\> | `{}` | Parameters to create a [Debug](Debug.md) instance. |
...
• **options**: [`DebugOptions`](../modules.md#debugoptions-6)
...
Register a new object attribute to track. Needs to call [update](Debug.md#update-18) in the game loop
to update the value.
