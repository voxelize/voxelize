...
| `options` | `Partial`\<[`DebugOptions`](../modules.md#debugoptions-124)\> | `{}` | Parameters to create a [Debug](Debug.md) instance. |
...
• **options**: [`DebugOptions`](../modules.md#debugoptions-124)
...
Register a new object attribute to track. Needs to call [Debug.update](Debug.md#update-124) in the game loop
to update the value.
