...
| `params` | [`NetworkParams`](../modules.md#networkparams-96) | Parameters to customize the connection to a Voxelize server. |
...
• **params**: [`NetworkParams`](../modules.md#networkparams-96)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-96)
