...
| Name | Type |
| :------ | :------ |
| `options` | `Partial`\<[`NetworkOptions`](../modules.md#networkoptions-30)\> |
...
• **options**: [`NetworkOptions`](../modules.md#networkoptions-30)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-30)
...
| `options` | [`NetworkConnectionOptions`](../modules.md#networkconnectionoptions-30) | Parameters to customize the connection to a Voxelize server. |
