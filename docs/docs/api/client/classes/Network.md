...
| `params` | [`NetworkParams`](../modules.md#networkparams-38) | Parameters to customize the connection to a Voxelize server. |
...
• **params**: [`NetworkParams`](../modules.md#networkparams-38)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-38)
