...
| Name | Type |
| :------ | :------ |
| `options` | `Partial`\<[`NetworkOptions`](../modules.md#networkoptions-8)\> |
...
• **options**: [`NetworkOptions`](../modules.md#networkoptions-8)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-8)
...
| `options` | [`NetworkConnectionOptions`](../modules.md#networkconnectionoptions-8) | Parameters to customize the connection to a Voxelize server. |
