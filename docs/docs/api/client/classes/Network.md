...
| Name | Type |
| :------ | :------ |
| `options` | `Partial`\<[`NetworkOptions`](../modules.md#networkoptions-32)\> |
...
• **options**: [`NetworkOptions`](../modules.md#networkoptions-32)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-32)
...
| `options` | [`NetworkConnectionOptions`](../modules.md#networkconnectionoptions-32) | Parameters to customize the connection to a Voxelize server. |
