...
| `options` | `Partial`\<[`PerspectiveOptions`](../modules.md#perspectiveoptions-168)\> | Parameters to configure the perspective. |
...
when [Perspective.connect](Perspective.md#connect-168) is called.
...
• **options**: [`PerspectiveOptions`](../modules.md#perspectiveoptions-168)
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-168) if it is implemented.
