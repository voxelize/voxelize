...
| `options` | `Partial`\<[`PerspectiveOptions`](../modules.md#perspectiveoptions-30)\> | Parameters to configure the perspective. |
...
when [Perspective.connect](Perspective.md#connect-30) is called.
...
• **options**: [`PerspectiveOptions`](../modules.md#perspectiveoptions-30)
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-30) if it is implemented.
