...
| `options` | `Partial`\<[`PerspectiveOptions`](../modules.md#perspectiveoptions-4)\> | Parameters to configure the perspective. |
...
when [Perspective.connect](Perspective.md#connect-4) is called.
...
• **options**: [`PerspectiveOptions`](../modules.md#perspectiveoptions-4)
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-4) if it is implemented.
