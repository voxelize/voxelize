...
| `options` | `Partial`\<[`PerspectiveOptions`](../modules.md#perspectiveoptions-404)\> | Parameters to configure the perspective. |
...
when [Perspective.connect](Perspective.md#connect-404) is called.
...
• **options**: [`PerspectiveOptions`](../modules.md#perspectiveoptions-404)
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-404) if it is implemented.
