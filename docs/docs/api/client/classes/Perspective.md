...
| `options` | `Partial`\<[`PerspectiveOptions`](../modules.md#perspectiveoptions-32)\> | Parameters to configure the perspective. |
...
when [Perspective.connect](Perspective.md#connect-32) is called.
...
• **options**: [`PerspectiveOptions`](../modules.md#perspectiveoptions-32)
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-32) if it is implemented.
