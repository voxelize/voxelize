...
| `options` | `Partial`\<[`PerspectiveOptions`](../modules.md#perspectiveoptions-124)\> | Parameters to configure the perspective. |
...
when [Perspective.connect](Perspective.md#connect-124) is called.
...
• **options**: [`PerspectiveOptions`](../modules.md#perspectiveoptions-124)
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-124) if it is implemented.
