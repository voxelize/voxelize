...
| `options` | `Partial`\<[`PerspectiveOptions`](../modules.md#perspectiveoptions-154)\> | Parameters to configure the perspective. |
...
when [Perspective.connect](Perspective.md#connect-154) is called.
...
• **options**: [`PerspectiveOptions`](../modules.md#perspectiveoptions-154)
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-154) if it is implemented.
