...
when [connect](Perspective.md#connect-6) is called.
...
• **params**: [`PerspectiveParams`](../modules.md#perspectiveparams-6)
...
| `params` | `Partial`<[`PerspectiveParams`](../modules.md#perspectiveparams-6)\> | Parameters to configure the perspective. |
...
Setter for the perspective's state. This will call [onChangeState](Perspective.md#onchangestate-6) if it is implemented.
