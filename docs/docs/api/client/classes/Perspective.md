...
| `options` | `Partial`\<[`PerspectiveOptions`](../modules.md#perspectiveoptions-406)\> | Parameters to configure the perspective. |
...
when [Perspective.connect](Perspective.md#connect-406) is called.
...
• **options**: [`PerspectiveOptions`](../modules.md#perspectiveoptions-406)
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-406) if it is implemented.
