...
| :------ | :------ | :------ | :------ |
| `coords` | [`Coords2`](../modules.md#coords2-166) | `undefined` | The coordinates to convert. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `coords` | [`Coords3`](../modules.md#coords3-166) | `undefined` | The coordinates to convert. |
| `concat` | `string` | `"|"` | The concatenation string to use. |
...
▸ **mapChunkToVoxel**(`chunkPos`, `chunkSize`): [`Coords3`](../modules.md#coords3-166)
...
| :------ | :------ | :------ |
| `chunkPos` | [`Coords2`](../modules.md#coords2-166) | The chunk coordinate to map. |
...
▸ **mapVoxelToChunk**(`voxelPos`, `chunkSize`): [`Coords2`](../modules.md#coords2-166)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `voxelPos` | [`Coords3`](../modules.md#coords3-166) | The voxel coordinate to map. |
| `chunkSize` | `number` | The horizontal dimension of a chunk. |
...
▸ **mapVoxelToChunkLocal**(`voxelPos`, `chunkSize`): [`Coords3`](../modules.md#coords3-166)
...
▸ **mapWorldToVoxel**(`worldPos`): [`Coords3`](../modules.md#coords3-166)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `worldPos` | [`Coords3`](../modules.md#coords3-166) | The world coordinate to map. |
...
▸ **scaleCoordsF**(`coords`, `factor`): [`Coords3`](../modules.md#coords3-166)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `coords` | [`Coords3`](../modules.md#coords3-166) | The coordinates to scale and floor. |
