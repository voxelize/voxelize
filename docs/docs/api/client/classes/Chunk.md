...
| `vy` | `number` | The y voxel coordinate |
| `vz` | `number` | The z voxel coordinate |
| `color` | [`LightColor`](../modules.md#lightcolor-168) | The color of the light to get at the given voxel coordinate. |
...
| `color` | [`LightColor`](../modules.md#lightcolor-168) | The color of the light to set at the given voxel coordinate. |
