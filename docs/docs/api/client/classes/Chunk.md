...
| `vy` | `number` | The y voxel coordinate |
| `vz` | `number` | The z voxel coordinate |
| `color` | [`LightColor`](../modules.md#lightcolor-6) | The color of the light to get at the given voxel coordinate. |
...
| `color` | [`LightColor`](../modules.md#lightcolor-6) | The color of the light to set at the given voxel coordinate. |
...
• **coords**: [`Coords2`](../modules.md#coords2-6)
...
through [getChunkName](ChunkUtils.md#getchunkname-6).

___

### params

• **params**: [`ChunkParams`](../modules.md#chunkparams-6)
...
| `params` | [`ChunkParams`](../modules.md#chunkparams-6) | The parameters to create a new chunk. |
