...
When using [Clouds.update](Clouds.md#update-124), new clouds will be generated if the center of the grid
...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`CloudsOptions`](../modules.md#cloudsoptions-124)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **locatedCell**: [`Coords2`](../modules.md#coords2-124)
...
• **options**: [`CloudsOptions`](../modules.md#cloudsoptions-124)
...
position passed into [Clouds.update](Clouds.md#update-124).
