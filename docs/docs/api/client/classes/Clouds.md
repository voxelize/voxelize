...
When using [update](Clouds.md#update-120), new clouds will be generated if the center of the grid
...
| :------ | :------ | :------ |
| `options` | `Partial`<[`CloudsOptions`](../modules.md#cloudsoptions-120)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **locatedCell**: [`Coords2`](../modules.md#coords2-120)
...
• **options**: [`CloudsOptions`](../modules.md#cloudsoptions-120)
...
position passed into [update](Clouds.md#update-120).
