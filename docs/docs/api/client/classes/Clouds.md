...
When using [Clouds.update](Clouds.md#update-154), new clouds will be generated if the center of the grid
...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`CloudsOptions`](../modules.md#cloudsoptions-154)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **locatedCell**: [`Coords2`](../modules.md#coords2-154)
...
• **options**: [`CloudsOptions`](../modules.md#cloudsoptions-154)
...
position passed into [Clouds.update](Clouds.md#update-154).
