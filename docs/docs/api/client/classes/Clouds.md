...
When using [update](Clouds.md#update-96), new clouds will be generated if the center of the grid
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CloudsParams`](../modules.md#cloudsparams-96)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **params**: [`CloudsParams`](../modules.md#cloudsparams-96)
...
position passed into [update](Clouds.md#update-96).
