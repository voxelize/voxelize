...
When using [Clouds.update](Clouds.md#update-30), new clouds will be generated if the center of the grid
...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`CloudsOptions`](../modules.md#cloudsoptions-30)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **locatedCell**: [`Coords2`](../modules.md#coords2-30)
...
• **options**: [`CloudsOptions`](../modules.md#cloudsoptions-30)
...
position passed into [Clouds.update](Clouds.md#update-30).
