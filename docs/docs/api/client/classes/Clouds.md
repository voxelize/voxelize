...
When using [Clouds.update](Clouds.md#update-4), new clouds will be generated if the center of the grid
...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`CloudsOptions`](../modules.md#cloudsoptions-4)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **options**: [`CloudsOptions`](../modules.md#cloudsoptions-4)
...
position passed into [Clouds.update](Clouds.md#update-4).
