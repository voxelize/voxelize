...
| :------ | :------ | :------ |
| `options` | `Partial`<[`CloudsOptions`](../modules.md#cloudsoptions-14)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **options**: [`CloudsOptions`](../modules.md#cloudsoptions-14)
