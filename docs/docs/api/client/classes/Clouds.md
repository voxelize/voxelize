...
When using [Clouds.update](Clouds.md#update-24), new clouds will be generated if the center of the grid
...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`CloudsOptions`](../modules.md#cloudsoptions-24)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **locatedCell**: [`Coords2`](../modules.md#coords2-24)
...
• **options**: [`CloudsOptions`](../modules.md#cloudsoptions-24)
...
position passed into [Clouds.update](Clouds.md#update-24).
