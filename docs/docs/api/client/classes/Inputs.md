...
You can change the above bindings by calling [remap](Inputs.md#remap-14) with the corresponding input identifiers, namely
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-14) | `{}` | The specific options of the key to listen for. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-14) | `undefined` | The type of click to listen for. Either "left", "middle" or "right". |
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-14) | The specifics of the key to unbind. |
