...
You can change the above bindings by calling [remap](Inputs.md#remap-114) with the corresponding input identifiers, namely
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-114) | `{}` | The specific parameters of the key to listen for. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-114) | `undefined` | The type of click to listen for. Either "left", "middle" or "right". |
...
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-114) | - |
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-114) | The specifics of the key to unbind. |
