...
You can change the above bindings by calling [Inputs.remap](Inputs.md#remap-124) with the corresponding input identifiers, namely
...
| `namespaces` | ``"*"`` \| `T` \| `T`[] | `"*"` | - |
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-124) | `{}` | The specific options of the key to listen for. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-124) | `undefined` | The type of click to listen for. Either "left", "middle" or "right". |
...
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-124) | - |
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-124) | The specifics of the key to unbind. |
