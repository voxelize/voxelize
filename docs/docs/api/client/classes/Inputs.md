...
You can change the above bindings by calling [Inputs.remap](Inputs.md#remap-406) with the corresponding input identifiers, namely
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-406) | `{}` | The specific options of the key to listen for. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-406) | `undefined` | The type of click to listen for. Either "left", "middle" or "right". |
...
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-406) | - |
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-406) | The specifics of the key to unbind. |
