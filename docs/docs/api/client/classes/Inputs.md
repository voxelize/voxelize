...
You can change the above bindings by calling [remap](Inputs.md#remap-38) with the corresponding input identifiers, namely
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-38) | `{}` | The specific parameters of the key to listen for. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-38) | `undefined` | The type of click to listen for. Either "left", "middle" or "right". |
...
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-38) | - |
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-38) | The specifics of the key to unbind. |
