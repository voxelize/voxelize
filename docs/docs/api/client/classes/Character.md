...
• **params**: [`CharacterParams`](../modules.md#characterparams-4)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-4)\> | Parameters to create a Voxelize character. |
