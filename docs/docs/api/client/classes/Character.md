...
• **params**: [`CharacterParams`](../modules.md#characterparams-38)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-38)\> | Parameters to create a Voxelize character. |
