...
• **options**: [`CharacterOptions`](../modules.md#characteroptions-6)
...
| :------ | :------ | :------ |
| `options` | `Partial`<[`CharacterOptions`](../modules.md#characteroptions-6)\> | Parameters to create a Voxelize character. |
