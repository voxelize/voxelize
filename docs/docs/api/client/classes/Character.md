...
• **params**: [`CharacterParams`](../modules.md#characterparams-114)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-114)\> | Parameters to create a Voxelize character. |
