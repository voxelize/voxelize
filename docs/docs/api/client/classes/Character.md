...
• **params**: [`CharacterParams`](../modules.md#characterparams-6)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-6)\> | Parameters to create a Voxelize character. |
