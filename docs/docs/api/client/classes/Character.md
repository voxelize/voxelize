...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`CharacterOptions`](../modules.md#characteroptions-406)\> | Parameters to create a Voxelize character. |
...
• **options**: [`CharacterOptions`](../modules.md#characteroptions-406)
