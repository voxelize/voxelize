...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`CharacterOptions`](../modules.md#characteroptions-32)\> | Parameters to create a Voxelize character. |
...
• **options**: [`CharacterOptions`](../modules.md#characteroptions-32)
