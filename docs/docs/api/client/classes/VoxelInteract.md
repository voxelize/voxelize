...
- [VoxelInteract.potential](VoxelInteract.md#potential-32): The potential block placement. This is the data of a block's orientation that can be placed.
- [VoxelInteract.target](VoxelInteract.md#target-32): The targeted block. This is the voxel that the camera is looking at.
...
| `options` | `Partial`\<[`VoxelInteractOptions`](../modules.md#voxelinteractoptions-32)\> | Parameters to customize the [VoxelInteract](VoxelInteract.md) instance. |
...
• **options**: [`VoxelInteractOptions`](../modules.md#voxelinteractoptions-32)
...
| `voxel` | [`Coords3`](../modules.md#coords3-32) | The 3D coordinates of the potential block placement. |
| `yRotation` | `number` | The rotation along the Y axis that the block placement's major axis should be facing. This only works if rotation is [PY_ROTATION](../modules.md#py_rotation-32) or [NY_ROTATION](../modules.md#ny_rotation-32). |
| `yRotation4` | `number` | - |
| `yRotation8` | `number` | - |
...
• **target**: [`Coords3`](../modules.md#coords3-32)
...
• `get` **lookingAt**(): [`Block`](../modules.md#block-32)
...
If no block is targeted, then [VoxelInteract.target](VoxelInteract.md#target-32) and [VoxelInteract.potential](VoxelInteract.md#potential-32) will both be `null`.
