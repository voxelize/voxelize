...
- [VoxelInteract.potential](VoxelInteract.md#potential-30): The potential block placement. This is the data of a block's orientation that can be placed.
- [VoxelInteract.target](VoxelInteract.md#target-30): The targeted block. This is the voxel that the camera is looking at.
...
| `options` | `Partial`\<[`VoxelInteractOptions`](../modules.md#voxelinteractoptions-30)\> | Parameters to customize the [VoxelInteract](VoxelInteract.md) instance. |
...
• **options**: [`VoxelInteractOptions`](../modules.md#voxelinteractoptions-30)
...
| `voxel` | [`Coords3`](../modules.md#coords3-30) | The 3D coordinates of the potential block placement. |
| `yRotation` | `number` | The rotation along the Y axis that the block placement's major axis should be facing. This only works if rotation is [PY_ROTATION](../modules.md#py_rotation-30) or [NY_ROTATION](../modules.md#ny_rotation-30). |
| `yRotation4` | `number` | - |
| `yRotation8` | `number` | - |
...
• **target**: [`Coords3`](../modules.md#coords3-30)
...
• `get` **lookingAt**(): [`Block`](../modules.md#block-30)
...
If no block is targeted, then [VoxelInteract.target](VoxelInteract.md#target-30) and [VoxelInteract.potential](VoxelInteract.md#potential-30) will both be `null`.
