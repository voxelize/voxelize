...
- [potential](VoxelInteract.md#potential-38): The potential block placement. This is the data of a block's orientation that can be placed.
- [target](VoxelInteract.md#target-38): The targeted block. This is the voxel that the camera is looking at.
...
• **params**: [`VoxelInteractParams`](../modules.md#voxelinteractparams-38)
...
| `voxel` | [`Coords3`](../modules.md#coords3-38) | The 3D coordinates of the potential block placement. |
| `yRotation` | `number` | The rotation along the Y axis that the block placement's major axis should be facing. This only works if rotation is [PY_ROTATION](../modules.md#py_rotation-38) or [NY_ROTATION](../modules.md#ny_rotation-38). |

___

### target

• **target**: [`Coords3`](../modules.md#coords3-38)
...
| `params` | `Partial`<[`VoxelInteractParams`](../modules.md#voxelinteractparams-38)\> | Parameters to customize the [VoxelInteract](VoxelInteract.md) instance. |
...
• `get` **lookingAt**(): [`Block`](../modules.md#block-38)
...
If no block is targeted, then [target](VoxelInteract.md#target-38) and [potential](VoxelInteract.md#potential-38) will both be `null`.
