...
- [VoxelInteract.potential](VoxelInteract.md#potential-406): The potential block placement. This is the data of a block's orientation that can be placed.
- [VoxelInteract.target](VoxelInteract.md#target-406): The targeted block. This is the voxel that the camera is looking at.
...
| `options` | `Partial`\<[`VoxelInteractOptions`](../modules.md#voxelinteractoptions-406)\> | Parameters to customize the [VoxelInteract](VoxelInteract.md) instance. |
...
• **options**: [`VoxelInteractOptions`](../modules.md#voxelinteractoptions-406)
...
| `voxel` | [`Coords3`](../modules.md#coords3-406) | The 3D coordinates of the potential block placement. |
| `yRotation` | `number` | The rotation along the Y axis that the block placement's major axis should be facing. This only works if rotation is [PY_ROTATION](../modules.md#py_rotation-406) or [NY_ROTATION](../modules.md#ny_rotation-406). |

___

### target

• **target**: [`Coords3`](../modules.md#coords3-406)
...
• `get` **lookingAt**(): [`Block`](../modules.md#block-406)
...
If no block is targeted, then [VoxelInteract.target](VoxelInteract.md#target-406) and [VoxelInteract.potential](VoxelInteract.md#potential-406) will both be `null`.
