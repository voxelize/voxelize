...
- [VoxelInteract.potential](VoxelInteract.md#potential-404): The potential block placement. This is the data of a block's orientation that can be placed.
- [VoxelInteract.target](VoxelInteract.md#target-404): The targeted block. This is the voxel that the camera is looking at.
...
| `options` | `Partial`\<[`VoxelInteractOptions`](../modules.md#voxelinteractoptions-404)\> | Parameters to customize the [VoxelInteract](VoxelInteract.md) instance. |
...
• **options**: [`VoxelInteractOptions`](../modules.md#voxelinteractoptions-404)
...
| `voxel` | [`Coords3`](../modules.md#coords3-404) | The 3D coordinates of the potential block placement. |
| `yRotation` | `number` | The rotation along the Y axis that the block placement's major axis should be facing. This only works if rotation is [PY_ROTATION](../modules.md#py_rotation-404) or [NY_ROTATION](../modules.md#ny_rotation-404). |

___

### target

• **target**: [`Coords3`](../modules.md#coords3-404)
...
• `get` **lookingAt**(): [`Block`](../modules.md#block-404)
...
If no block is targeted, then [VoxelInteract.target](VoxelInteract.md#target-404) and [VoxelInteract.potential](VoxelInteract.md#potential-404) will both be `null`.
