...
- [potential](VoxelInteract.md#potential-18): The potential block placement. This is the data of a block's orientation that can be placed.
- [target](VoxelInteract.md#target-18): The targeted block. This is the voxel that the camera is looking at.
...
• **options**: [`VoxelInteractOptions`](../modules.md#voxelinteractoptions-6)
...
| `voxel` | [`Coords3`](../modules.md#coords3-18) | The 3D coordinates of the potential block placement. |
| `yRotation` | `number` | The rotation along the Y axis that the block placement's major axis should be facing. This only works if rotation is [PY_ROTATION](../modules.md#py_rotation-18) or [NY_ROTATION](../modules.md#ny_rotation-18). |

___

### target

• **target**: [`Coords3`](../modules.md#coords3-18)
...
| `options` | `Partial`<[`VoxelInteractOptions`](../modules.md#voxelinteractoptions-6)\> | Parameters to customize the [VoxelInteract](VoxelInteract.md) instance. |
...
• `get` **lookingAt**(): [`Block`](../modules.md#block-18)
...
If no block is targeted, then [target](VoxelInteract.md#target-18) and [potential](VoxelInteract.md#potential-18) will both be `null`.
