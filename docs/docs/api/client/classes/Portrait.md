...
• **params**: [`PortraitParams`](../modules.md#portraitparams-4)
...
| `params` | `Partial`<[`PortraitParams`](../modules.md#portraitparams-4)\> | The parameters to create this portrait with. |
