...
| `options` | `Partial`\<[`PortraitOptions`](../modules.md#portraitoptions-406)\> | The options to create this portrait with. |
...
• **options**: [`PortraitOptions`](../modules.md#portraitoptions-406)
