...
| `options` | `Partial`\<[`PortraitOptions`](../modules.md#portraitoptions-168)\> | The options to create this portrait with. |
...
• **options**: [`PortraitOptions`](../modules.md#portraitoptions-168)
