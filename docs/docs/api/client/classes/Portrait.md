...
• **options**: [`PortraitOptions`](../modules.md#portraitoptions-14)
...
| `options` | `Partial`<[`PortraitOptions`](../modules.md#portraitoptions-14)\> | The options to create this portrait with. |
