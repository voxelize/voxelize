...
| :------ | :------ | :------ | :------ |
| `range` | [`TextureRange`](../modules.md#texturerange-18) | `undefined` | The range of the texture atlas that this animation uses. |
...
• **range**: [`TextureRange`](../modules.md#texturerange-18)
