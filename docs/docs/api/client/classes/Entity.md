...
The default setting for [matrixAutoUpdate](Entity.md#matrixautoupdate-120) for newly created Object3Ds.
...
The default setting for [matrixWorldAutoUpdate](Entity.md#matrixworldautoupdate-120) for newly created Object3Ds.
...
The default [up](Entity.md#up-120) direction for objects, also used as the default position for DirectionalLight,
...
This is used by the [lookAt](Entity.md#lookat-120) method, for example, to determine the orientation of the result.
