...
- [World.registry](World.md#registry-406): A block registry that handles block textures and block instances.
- [World.chunks](World.md#chunks-406): A chunk manager that stores all the chunks in the world.
- [World.physics](World.md#physics-406): A physics engine that handles voxel AABB physics simulation of client-side physics.
- [World.loader](World.md#loader-406): An asset loader that handles loading textures and other assets.
- [World.sky](World.md#sky-406): A sky that can render the sky and the sun.
- [World.clouds](World.md#clouds-406): A clouds that renders the cubical clouds.
...
| :------ | :------ | :------ |
| `options` | `Partial`\<[`WorldOptions`](../modules.md#worldoptions-406)\> | The options to create the world. |
...
• **options**: [`WorldOptions`](../modules.md#worldoptions-406)
...
| Name | Type |
| :------ | :------ |
| `listener` | [`BlockUpdateListener`](../modules.md#blockupdatelistener-406) |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `coords` | [`Coords2`](../modules.md#coords2-406) | The chunk coordinates to listen to. |
...
using [applyBlockFrames](World.md#applyblockframes-406) internally.
...
Apply multiple block textures at once. See [applyBlockTexture](World.md#applyblocktexture-406) for more information.
...
| `fn` | (`pos`: [`Coords3`](../modules.md#coords3-406)) => \{ `aabbs`: `AABB`[] ; `faces`: \{ `corners`: \{ `pos`: [`number`, `number`, `number`] ; `uv`: `number`[]  }[] ; `dir`: [`number`, `number`, `number`] ; `independent`: `boolean` ; `name`: `string` ; `range`: [`UV`](../modules.md#uv-406)  }[] ; `isTransparent`: [`boolean`, `boolean`, `boolean`, `boolean`, `boolean`, `boolean`]  } |
...
▸ **customizeMaterialShaders**(`idOrName`, `faceName?`, `data?`): [`CustomChunkShaderMaterial`](../modules.md#customchunkshadermaterial-406)
...
[`CustomChunkShaderMaterial`](../modules.md#customchunkshadermaterial-406)
...
| Name | Type |
| :------ | :------ |
| `queue` | [`LightNode`](../modules.md#lightnode-406)[] |
| `color` | [`LightColor`](../modules.md#lightcolor-406) |
...
▸ **getBlockAt**(`px`, `py`, `pz`): [`Block`](../modules.md#block-406)
...
▸ **getBlockById**(`id`): [`Block`](../modules.md#block-406)
...
▸ **getBlockByName**(`name`): [`Block`](../modules.md#block-406)
...
▸ **getBlockFaceMaterial**(`idOrName`, `faceName?`): [`CustomChunkShaderMaterial`](../modules.md#customchunkshadermaterial-406)
...
▸ **getBlockOf**(`idOrName`): [`Block`](../modules.md#block-406)
...
| `py` | `number` | The y coordinate of the position. |
| `pz` | `number` | The z coordinate of the position. |
| `color` | [`LightColor`](../modules.md#lightcolor-406) | The color of the torch light. |
...
| Name | Type |
| :------ | :------ |
| `center` | [`Coords2`](../modules.md#coords2-406) |
| `target` | [`Coords2`](../modules.md#coords2-406) |
| `direction` | `Vector3` |
| `threshold` | `number` |
...
is within [WorldServerOptions.minChunk](../modules.md#worldserveroptions-406) and [WorldServerOptions.maxChunk](../modules.md#worldserveroptions-406).
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `origin` | [`Coords3`](../modules.md#coords3-406) | The origin of the ray. |
| `direction` | [`Coords3`](../modules.md#coords3-406) | The direction of the ray. |
...
[World.chunks.toUpdate](World.md#chunks-406) and scaffolded to the server [WorldClientOptions.maxUpdatesPerUpdate](../modules.md#worldclientoptions-406) times
per tick. Keep in mind that for rotation and y-rotation, the value should be one of the following:
- Rotation: [PX_ROTATION](../modules.md#px_rotation-406) | [NX_ROTATION](../modules.md#nx_rotation-406) | [PY_ROTATION](../modules.md#py_rotation-406) | [NY_ROTATION](../modules.md#ny_rotation-406) | [PZ_ROTATION](../modules.md#pz_rotation-406) | [NZ_ROTATION](../modules.md#nz_rotation-406)
- Y-rotation: 0 to [Y_ROT_SEGMENTS](../modules.md#y_rot_segments-406) - 1.

This ignores blocks that are not defined, and also ignores rotations for blocks that are not [Block.rotatable](../modules.md#block-406) (Same for if
block is not [Block.yRotatable](../modules.md#block-406)).
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `updates` | [`BlockUpdate`](../modules.md#blockupdate-406)[] | `undefined` | A list of updates to send to the server. |
| `source` | ``"client"`` \| ``"server"`` | `"client"` | - |
