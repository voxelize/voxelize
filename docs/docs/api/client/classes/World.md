...
- [registry](World.md#registry-6): A block registry that handles block textures and block instances.
- [chunks](World.md#chunks-6): A chunk manager that stores all the chunks in the world.
- [physics](World.md#physics-6): A physics engine that handles voxel AABB physics simulation of client-side physics.
- [loader](World.md#loader-6): An asset loader that handles loading textures and other assets.
- [atlas](World.md#atlas-6): A texture atlas that handles texture packing.
...
| :------ | :------ | :------ |
| `coords` | [`Coords2`](../modules.md#coords2-6) | The chunk coordinates to listen to. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `texture` | [`TextureData`](../modules.md#texturedata-6) | The data of the texture and where the texture is applying to. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `textures` | [`TextureData`](../modules.md#texturedata-6)[] | List of data to load into the game before the game starts. |
...
▸ **getBlockById**(`id`): [`Block`](../modules.md#block-6)
...
▸ **getBlockByName**(`name`): [`Block`](../modules.md#block-6)
...
▸ **getBlockByTextureName**(`textureName`): [`Block`](../modules.md#block-6)
...
▸ **getBlockByVoxel**(`vx`, `vy`, `vz`): [`Block`](../modules.md#block-6)
...
▸ **getBlockByWorld**(`wx`, `wy`, `wz`): [`Block`](../modules.md#block-6)
...
| `vy` | `number` | The voxel's Y position. |
| `vz` | `number` | The voxel's Z position. |
| `color` | [`LightColor`](../modules.md#lightcolor-6) | The color of the torch light to get. |
...
is within [WorldServerParams.minChunk](../modules.md#worldserverparams-6) and [WorldServerParams.maxChunk](../modules.md#worldserverparams-6).
...
[World.chunks.toUpdate](World.md#chunks-6) and scaffolded to the server [WorldClientParams.maxUpdatesPerTick](../modules.md#worldclientparams-6) times
per tick. Keep in mind that for rotation and y-rotation, the value should be one of the following:
- Rotation: [PX_ROTATION](../modules.md#px_rotation-6) | [NX_ROTATION](../modules.md#nx_rotation-6) | [PY_ROTATION](../modules.md#py_rotation-6) | [NY_ROTATION](../modules.md#ny_rotation-6) | [PZ_ROTATION](../modules.md#pz_rotation-6) | [NZ_ROTATION](../modules.md#nz_rotation-6)
- Y-rotation: 0 to [Y_ROT_SEGMENTS](../modules.md#y_rot_segments-6) - 1.

This ignores blocks that are not defined, and also ignores rotations for blocks that are not [Block.rotatable](../modules.md#block-6) (Same for if
block is not [Block.yRotatable](../modules.md#block-6)).
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `updates` | [`BlockUpdate`](../modules.md#blockupdate-6)[] | A list of updates to send to the server. |
...
Use [getPreviousVoxelByVoxel](World.md#getpreviousvoxelbyvoxel-6) and [getPreviousVoxelByWorld](World.md#getpreviousvoxelbyworld-6) to get the previous
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `opaque?` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-6) | The chunk material that is used to render the opaque portions of the chunk meshes. |
| `transparent?` | { `back`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-6) ; `front`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-6)  } | The chunk materials that are used to render the transparent portions of the chunk meshes. This consists of two sides of the chunk mesh, front and back. |
| `transparent.back` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-6) | The back side of the chunk mesh's transparent material. |
| `transparent.front` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-6) | The front side of the chunk mesh's transparent material. |

___

### params

• **params**: [`WorldParams`](../modules.md#worldparams-6) = `{}`

Parameters to configure the world. This is a combination of the client-side parameters, [WorldClientParams](../modules.md#worldclientparams-6),
and the server-side parameters, [WorldServerParams](../modules.md#worldserverparams-6). The server-side parameters are defined on the server, and
...
| `atlas` | { `value`: `Texture`  } | The 2D texture atlas that is used to render the chunk. This will be set after [atlas](World.md#atlas-6) is generated. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `params` | `Partial`<[`WorldClientParams`](../modules.md#worldclientparams-6)\> | The client-side parameters to configure the world. |
