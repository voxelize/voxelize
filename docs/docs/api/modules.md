...
| `borderRadius` | [`CSSMeasurement`](modules.md#cssmeasurement-116) | Border radius of both the radius and the message list. Defaults to `4px`. |
...
| `gap` | [`CSSMeasurement`](modules.md#cssmeasurement-116) | The gap between the input and the message list. Defaults to `26px`. |
| `helpText` | `string` | A text message that is sent to the client frontend-only when '/help' is typed in the chat. |
| `inputHeight` | [`CSSMeasurement`](modules.md#cssmeasurement-116) | Height of the chat input. Defaults to `29px`. |
| `inputWidth` | [`CSSMeasurement`](modules.md#cssmeasurement-116) | Width of the chat input, not regarding the margins. Defaults to `100%`. |
| `margin` | [`CSSMeasurement`](modules.md#cssmeasurement-116) | The margin of the chat to the viewport in pixels. Defaults to `8px`. |
| `messagesWidth` | [`CSSMeasurement`](modules.md#cssmeasurement-116) | The default width of the message list. Defaults to `40vw`. |
...
| `initialPosition` | [`Coords3`](modules.md#coords3-116) | Initial position of the client. Defaults to `(0, 80, 10)`. |
...
| `impulseFunc` | (`f`: `number`) => [`Coords3`](modules.md#coords3-116) | A function returning a 3-element array that modifies the force applied on each particle. |
| `update` | (`g`: [`ParticleGroup`](modules.md#particlegroup-32)) => `void` | A function used to update the particles. |
...
| `params` | [`ParticleParams`](modules.md#particleparams-32) | Parameters used to initialize this particle group. |
...
| `skyFaces` | [`PartialRecord`](modules.md#partialrecord-116)<[`BoxSides`](modules.md#boxsides-116), `SkyFace`\> |
...
| `lights` | `Uint32Array` |
| `voxels` | `Uint32Array` |
| `mesh` | [`ServerMesh`](modules.md#servermesh-116) |
...
| `voxel?` | [`Coords3`](modules.md#coords3-116) | The voxel at which to offset the voxelizer at. |
...
Ƭ **BlockFace**: keyof [`AllFaces`](modules.md#allfaces-116) \| keyof [`ThreeFaces`](modules.md#threefaces-116) \| keyof [`SixFaces`](modules.md#sixfaces-116) \| keyof [`PlantFaces`](modules.md#plantfaces-116)
...
| `faces` | [`BlockFace`](modules.md#blockface-116)[] |
| `aabbs` | `AABB`[] |
...
| Name | Type |
| :------ | :------ |
| `opaque?` | [`MeshData`](modules.md#meshdata-116) |
| `transparent?` | [`MeshData`](modules.md#meshdata-116) |
...
• `Const` **DirtyFlag**: [`ComponentClassType`](modules.md#componentclasstype-116)<`unknown`\>

___

### EntityFlag

• `Const` **EntityFlag**: [`ComponentClassType`](modules.md#componentclasstype-116)<`unknown`\>

___

### ClientFlag

• `Const` **ClientFlag**: [`ComponentClassType`](modules.md#componentclasstype-116)<`unknown`\>

___

### ChunkFlag

• `Const` **ChunkFlag**: [`ComponentClassType`](modules.md#componentclasstype-116)<`unknown`\>

___

### HeadingComponent

• `Const` **HeadingComponent**: [`ComponentClassType`](modules.md#componentclasstype-116)<`Vector3`\>

___

### IDComponent

• `Const` **IDComponent**: [`ComponentClassType`](modules.md#componentclasstype-116)<`string`\>

___

### MeshComponent

• `Const` **MeshComponent**: [`ComponentClassType`](modules.md#componentclasstype-116)<`Object3D`<`Event`\>\>

___

### MetadataComponent

• `Const` **MetadataComponent**: [`ComponentClassType`](modules.md#componentclasstype-116)<{ `[key: string]`: `any`;  }\>

___

### NameComponent

• `Const` **NameComponent**: [`ComponentClassType`](modules.md#componentclasstype-116)<`string`\>

___

### Position3DComponent

• `Const` **Position3DComponent**: [`ComponentClassType`](modules.md#componentclasstype-116)<`Vector3`\>

___

### TargetComponent

• `Const` **TargetComponent**: [`ComponentClassType`](modules.md#componentclasstype-116)<`Vector3`\>

___

### TypeComponent

• `Const` **TypeComponent**: [`ComponentClassType`](modules.md#componentclasstype-116)<`string`\>

___

### defaultBlock

• `Const` **defaultBlock**: [`Block`](modules.md#block-116)
...
| :------ | :------ |
| `getVoxel` | `GetVoxel` |
| `origin` | [`Coords3`](modules.md#coords3-116) |
| `direction` | [`Coords3`](modules.md#coords3-116) |
| `maxD` | `number` |
| `hitPos` | [`Coords3`](modules.md#coords3-116) |
| `hitNorm` | [`Coords3`](modules.md#coords3-116) |
