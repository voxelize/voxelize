...
WASM-pack JSON reports include check inventory and execution partitions such as `availableChecks`, `availableCheckCommandMap`, `availableCheckArgsMap`, `availableCheckArgCountMap`, `availableCheckIndexMap`, `checkLabels`, `checkStatusMap`, `checkVersionMap`, `checkExitCodeMap`, `checkOutputLineMap`, `passedChecks`, `failedChecks`, `failureSummaries`, and associated `*Count` fields.
