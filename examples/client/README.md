...
Client aggregate JSON reports include `availableSteps`, `availableStepCount`, `totalSteps`, `passedStepCount`, `failedStepCount`, `skippedStepCount`, `firstFailedStep`, `passedSteps`, `failedSteps`, and `skippedSteps`.
