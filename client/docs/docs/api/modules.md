...
• `Const` **BOX\_SIDES**: [`BoxSides`](modules.md#boxsides-472)[]
...
| Name | Type |
| :------ | :------ |
| `drawCrown` | [`ArtFunction`](modules.md#artfunction-472) |
| `drawSun` | [`ArtFunction`](modules.md#artfunction-472) |

## Type Aliases

### ArmsParams

Ƭ **ArmsParams**: [`CanvasBoxParams`](modules.md#canvasboxparams-472) & { `shoulderDrop?`: `number` ; `shoulderGap?`: `number`  }
...
Ƭ **BodyParams**: [`CanvasBoxParams`](modules.md#canvasboxparams-472)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `arms?` | `Partial`<[`ArmsParams`](modules.md#armsparams-472)\> | Parameters to create the character's arms. |
| `body?` | `Partial`<[`BodyParams`](modules.md#bodyparams-472)\> | Parameters to create the character's body. |
| `head?` | `Partial`<[`HeadParams`](modules.md#headparams-472)\> | Parameters to create the character's head. |
| `idleArmSwing?` | `number` | The speed at which the arms swing when the character is idle. Defaults to `0.06`. |
| `legs?` | `Partial`<[`LegParams`](modules.md#legparams-472)\> | Parameters to create the character's legs. |
...
| `dimensions` | [`Coords3`](modules.md#coords3-472) | The dimension of each cloud block. Defaults to `[20, 20, 20]`. |
...
| Name | Type |
| :------ | :------ |
| `dimensions` | [`Coords3`](modules.md#coords3-472) |
| `max` | [`Coords3`](modules.md#coords3-472) |
| `min` | [`Coords3`](modules.md#coords3-472) |
| `realMax` | [`Coords3`](modules.md#coords3-472) |
| `realMin` | [`Coords3`](modules.md#coords3-472) |
...
| `onByDefault` | `boolean` | Whether or not should the debug panel be displayed by default when the page loads. Defaults to `true`. You can toggle the debug panel by calling [Debug.toggle](classes/Debug.md#toggle-472). |
...
Ƭ **HeadParams**: [`CanvasBoxParams`](modules.md#canvasboxparams-472) & { `neckGap?`: `number`  }
...
| `occasion?` | [`InputOccasion`](modules.md#inputoccasion-472) | The occasion that the input should be fired. Defaults to `keydown`. |

___

### LegParams

Ƭ **LegParams**: [`CanvasBoxParams`](modules.md#canvasboxparams-472) & { `betweenLegsGap?`: `number`  }
...
| `initialPosition` | [`Coords3`](modules.md#coords3-472) | Initial position of the client. Defaults to `(0, 80, 10)`. |
...
Ƭ **SkyFace**: [`ArtFunction`](modules.md#artfunction-472) \| `Color` \| `string` \| ``null``
...
Data passed to [applyTextureByName](classes/World.md#applytexturebyname-472) or [applyTexturesByNames](classes/World.md#applytexturesbynames-472) to load a block texture.
...
Ƭ **WorldParams**: [`WorldClientParams`](modules.md#worldclientparams-472) & [`WorldServerParams`](modules.md#worldserverparams-472)
...
▸ **cull**(`array`, `options`): `Promise`<[`MeshResultType`](modules.md#meshresulttype-472)\>
...
| `options` | [`CullOptionsType`](modules.md#culloptionstype-472) |

#### Returns

`Promise`<[`MeshResultType`](modules.md#meshresulttype-472)\>
