...
• `Const` **BOX\_SIDES**: [`BoxSides`](modules.md#boxsides-128)[]
...
| Name | Type |
| :------ | :------ |
| `drawCrown` | [`ArtFunction`](modules.md#artfunction-128) |
| `drawSun` | [`ArtFunction`](modules.md#artfunction-128) |

## Type Aliases

### ArmsParams

Ƭ **ArmsParams**: [`CanvasBoxParams`](modules.md#canvasboxparams-128) & { `shoulderDrop?`: `number` ; `shoulderGap?`: `number`  }
...
Ƭ **BodyParams**: [`CanvasBoxParams`](modules.md#canvasboxparams-128)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `arms?` | `Partial`<[`ArmsParams`](modules.md#armsparams-128)\> | Parameters to create the character's arms. |
| `body?` | `Partial`<[`BodyParams`](modules.md#bodyparams-128)\> | Parameters to create the character's body. |
| `head?` | `Partial`<[`HeadParams`](modules.md#headparams-128)\> | Parameters to create the character's head. |
| `idleArmSwing?` | `number` | The speed at which the arms swing when the character is idle. Defaults to `0.06`. |
| `legs?` | `Partial`<[`LegParams`](modules.md#legparams-128)\> | Parameters to create the character's legs. |
...
| `dimensions` | [`Coords3`](modules.md#coords3-128) | The dimension of each cloud block. Defaults to `[20, 20, 20]`. |
...
| Name | Type |
| :------ | :------ |
| `dimensions` | [`Coords3`](modules.md#coords3-128) |
| `max` | [`Coords3`](modules.md#coords3-128) |
| `min` | [`Coords3`](modules.md#coords3-128) |
| `realMax` | [`Coords3`](modules.md#coords3-128) |
| `realMin` | [`Coords3`](modules.md#coords3-128) |
...
| `onByDefault` | `boolean` | Whether or not should the debug panel be displayed by default when the page loads. Defaults to `true`. You can toggle the debug panel by calling [Debug.toggle](classes/Debug.md#toggle-128). |
...
Ƭ **HeadParams**: [`CanvasBoxParams`](modules.md#canvasboxparams-128) & { `neckGap?`: `number`  }
...
| `occasion?` | [`InputOccasion`](modules.md#inputoccasion-128) | The occasion that the input should be fired. Defaults to `keydown`. |

___

### LegParams

Ƭ **LegParams**: [`CanvasBoxParams`](modules.md#canvasboxparams-128) & { `betweenLegsGap?`: `number`  }
...
Ƭ **SkyFace**: [`ArtFunction`](modules.md#artfunction-128) \| `Color` \| `string` \| ``null``
...
Data passed to [applyTextureByName](classes/World.md#applytexturebyname-128) or [applyTexturesByNames](classes/World.md#applytexturesbynames-128) to load a block texture.
...
Ƭ **WorldParams**: [`WorldClientParams`](modules.md#worldclientparams-128) & [`WorldServerParams`](modules.md#worldserverparams-128)
...
▸ **cull**(`array`, `options`): `Promise`<[`MeshResultType`](modules.md#meshresulttype-128)\>
...
| `options` | [`CullOptionsType`](modules.md#culloptionstype-128) |

#### Returns

`Promise`<[`MeshResultType`](modules.md#meshresulttype-128)\>
