...
• **toUpdate**: [`BlockUpdate`](../modules.md#blockupdate-82)[] = `[]`

A list of [BlockUpdate](../modules.md#blockupdate-82) objects that awaits to be sent to the server to make actual voxel
