...
| `params` | `Partial`<[`LightShinedParams`](../modules.md#lightshinedparams-384)\> | Parameters to customize the effect. |
...
• **params**: [`LightShinedParams`](../modules.md#lightshinedparams-384)
