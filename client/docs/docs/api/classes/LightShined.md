...
| `params` | `Partial`<[`LightShinedParams`](../modules.md#lightshinedparams-128)\> | Parameters to customize the effect. |
...
• **params**: [`LightShinedParams`](../modules.md#lightshinedparams-128)
