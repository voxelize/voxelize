...
| `params` | `Partial`<[`LightShinedParams`](../modules.md#lightshinedparams-480)\> | Parameters to customize the effect. |
...
• **params**: [`LightShinedParams`](../modules.md#lightshinedparams-480)
