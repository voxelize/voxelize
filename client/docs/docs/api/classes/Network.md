...
| `params` | [`NetworkParams`](../modules.md#networkparams-410) | Parameters to customize the connection to a Voxelize server. |
...
• **params**: [`NetworkParams`](../modules.md#networkparams-410)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-410)
