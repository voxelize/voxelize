...
• **params**: [`NetworkParams`](../modules.md#networkparams-40)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-40)
...
| `params` | [`NetworkParams`](../modules.md#networkparams-40) | Parameters to customize the connection to a Voxelize server. |
