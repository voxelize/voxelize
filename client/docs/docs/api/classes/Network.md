...
| `params` | [`NetworkParams`](../modules.md#networkparams-472) | Parameters to customize the connection to a Voxelize server. |
...
• **params**: [`NetworkParams`](../modules.md#networkparams-472)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-472)
