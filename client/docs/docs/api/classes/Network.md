...
• **params**: [`NetworkParams`](../modules.md#networkparams-198)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-198)
...
| `params` | [`NetworkParams`](../modules.md#networkparams-198) | Parameters to customize the connection to a Voxelize server. |
