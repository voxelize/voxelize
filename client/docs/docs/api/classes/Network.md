...
• **params**: [`NetworkParams`](../modules.md#networkparams-394)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-394)
...
| `params` | [`NetworkParams`](../modules.md#networkparams-394) | Parameters to customize the connection to a Voxelize server. |
