...
| `params` | [`NetworkParams`](../modules.md#networkparams-94) | Parameters to customize the connection to a Voxelize server. |
...
• **params**: [`NetworkParams`](../modules.md#networkparams-94)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-94)
