...
• **params**: [`NetworkParams`](../modules.md#networkparams-98)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-98)
...
| `params` | [`NetworkParams`](../modules.md#networkparams-98) | Parameters to customize the connection to a Voxelize server. |
