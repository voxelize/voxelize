...
• **params**: [`NetworkParams`](../modules.md#networkparams-90)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-90)
...
| `params` | [`NetworkParams`](../modules.md#networkparams-90) | Parameters to customize the connection to a Voxelize server. |
