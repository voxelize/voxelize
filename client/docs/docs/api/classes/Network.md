...
| `params` | [`NetworkParams`](../modules.md#networkparams-384) | Parameters to customize the connection to a Voxelize server. |
...
• **params**: [`NetworkParams`](../modules.md#networkparams-384)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-384)
