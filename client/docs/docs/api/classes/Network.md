...
• **params**: [`NetworkParams`](../modules.md#networkparams-74)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-74)
...
| `params` | [`NetworkParams`](../modules.md#networkparams-74) | Parameters to customize the connection to a Voxelize server. |
