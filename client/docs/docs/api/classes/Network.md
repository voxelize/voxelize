...
• **params**: [`NetworkParams`](../modules.md#networkparams-16)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-16)
...
| `params` | [`NetworkParams`](../modules.md#networkparams-16) | Parameters to customize the connection to a Voxelize server. |
