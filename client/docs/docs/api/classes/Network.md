...
• **params**: [`NetworkParams`](../modules.md#networkparams-556)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-556)
...
| `params` | [`NetworkParams`](../modules.md#networkparams-556) | Parameters to customize the connection to a Voxelize server. |
