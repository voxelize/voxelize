...
| `params` | [`NetworkParams`](../modules.md#networkparams-480) | Parameters to customize the connection to a Voxelize server. |
...
• **params**: [`NetworkParams`](../modules.md#networkparams-480)
...
• **ws**: [`ProtocolWS`](../modules.md#protocolws-480)
