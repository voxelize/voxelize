...
| `params` | [`NetworkParams`](../modules.md#networkparams-8) | Parameters to customize the connection to a Voxelize server. |
...
• **params**: [`NetworkParams`](../modules.md#networkparams-8)
