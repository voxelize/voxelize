...
| `params` | `Partial`<[`DebugParams`](../modules.md#debugparams-128)\> | `{}` | Parameters to create a [Debug](Debug.md) instance. |
...
• **params**: [`DebugParams`](../modules.md#debugparams-128)
...
Register a new object attribute to track. Needs to call [Debug.update](Debug.md#update-128) in the game loop
to update the value.
