...
| `params` | `Partial`<[`DebugParams`](../modules.md#debugparams-480)\> | `{}` | Parameters to create a [Debug](Debug.md) instance. |
...
• **params**: [`DebugParams`](../modules.md#debugparams-480)
...
Register a new object attribute to track. Needs to call [Debug.update](Debug.md#update-480) in the game loop
to update the value.
