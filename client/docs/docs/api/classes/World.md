...
| Name | Type |
| :------ | :------ |
| `opaque?` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-472) |
| `transparent?` | { `back`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-472) ; `front`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-472)  } |
| `transparent.back` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-472) |
| `transparent.front` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-472) |
...
[NetIntercept](../interfaces/NetIntercept.md).[packets](../interfaces/NetIntercept.md#packets-472)

___

### params

• **params**: [`WorldParams`](../modules.md#worldparams-472) = `{}`
...
| Name | Type |
| :------ | :------ |
| `coords` | [`Coords2`](../modules.md#coords2-472) |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `texture` | [`TextureData`](../modules.md#texturedata-472) | The data of the texture and where the texture is applying to. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `textures` | [`TextureData`](../modules.md#texturedata-472)[] | List of data to load into the game before the game starts. |
...
▸ **getBlockById**(`id`): [`Block`](../modules.md#block-472)
...
▸ **getBlockByName**(`name`): [`Block`](../modules.md#block-472)
...
▸ **getBlockByTextureName**(`textureName`): [`Block`](../modules.md#block-472)
...
▸ **getBlockByVoxel**(`vx`, `vy`, `vz`): [`Block`](../modules.md#block-472)
...
▸ **getBlockByWorld**(`wx`, `wy`, `wz`): [`Block`](../modules.md#block-472)
...
| `vy` | `number` |
| `vz` | `number` |
| `color` | [`LightColor`](../modules.md#lightcolor-472) |
...
| Name | Type |
| :------ | :------ |
| `message` | `MessageProtocol`<{ `blocks`: [`Block`](../modules.md#block-472)[] ; `params`: [`WorldServerParams`](../modules.md#worldserverparams-472) ; `ranges`: { `[key: string]`: [`TextureRange`](../modules.md#texturerange-472);  }  }, `any`, `any`, `any`\> |
...
[NetIntercept](../interfaces/NetIntercept.md).[onMessage](../interfaces/NetIntercept.md#onmessage-472)
...
| Name | Type |
| :------ | :------ |
| `data` | [`WorldServerParams`](../modules.md#worldserverparams-472) |
...
| Name | Type |
| :------ | :------ |
| `updates` | [`BlockUpdate`](../modules.md#blockupdate-472)[] |
...
| Name | Type |
| :------ | :------ |
| `params` | `Partial`<[`WorldClientParams`](../modules.md#worldclientparams-472)\> |
