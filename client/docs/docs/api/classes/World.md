...
- [World.atlas](World.md#atlas): A texture atlas that handles texture packing.
...
Use [World.getPreviousVoxelByVoxel](World.md#getpreviousvoxelbyvoxel) and [World.getPreviousVoxelByWorld](World.md#getpreviousvoxelbyworld) to get the previous
...
| `atlas` | { `value`: `Texture`  } | The 2D texture atlas that is used to render the chunk. This will be set after [World.atlas](World.md#atlas) is generated. |
