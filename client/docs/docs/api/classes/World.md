...
| Name | Type |
| :------ | :------ |
| `opaque?` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-82) |
| `transparent?` | { `back`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-82) ; `front`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-82)  } |
| `transparent.back` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-82) |
| `transparent.front` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-82) |
...
• **params**: [`WorldParams`](../modules.md#worldparams-82) = `{}`
...
▸ **getBlockByVoxel**(`vx`, `vy`, `vz`): [`Block`](../modules.md#block-82)
...
▸ **getBlockByWorld**(`wx`, `wy`, `wz`): [`Block`](../modules.md#block-82)
...
| `vy` | `number` |
| `vz` | `number` |
| `color` | [`LightColor`](../modules.md#lightcolor-82) |
...
| Name | Type |
| :------ | :------ |
| `message` | `MessageProtocol`<{ `blocks`: [`Block`](../modules.md#block-82)[] ; `params`: [`WorldServerParams`](../modules.md#worldserverparams-82) ; `ranges`: { `[key: string]`: [`TextureRange`](../modules.md#texturerange-82);  }  }, `any`, `any`, `any`\> |
...
| Name | Type |
| :------ | :------ |
| `data` | [`WorldServerParams`](../modules.md#worldserverparams-82) |
...
| Name | Type |
| :------ | :------ |
| `updates` | [`BlockUpdate`](../modules.md#blockupdate-82)[] |
...
| Name | Type |
| :------ | :------ |
| `params` | `Partial`<[`WorldClientParams`](../modules.md#worldclientparams-82)\> |
