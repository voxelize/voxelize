...
- [registry](World.md#registry-8): A block registry that handles block textures and block instances.
- [chunks](World.md#chunks-8): A chunk manager that stores all the chunks in the world.
- [physics](World.md#physics-8): A physics engine that handles voxel AABB physics simulation of client-side physics.
- [loader](World.md#loader-8): An asset loader that handles loading textures and other assets.
- [atlas](World.md#atlas-8): A texture atlas that handles texture packing.
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `texture` | [`TextureData`](../modules.md#texturedata-8) | The data of the texture and where the texture is applying to. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `textures` | [`TextureData`](../modules.md#texturedata-8)[] | List of data to load into the game before the game starts. |
...
▸ **getBlockByTextureName**(`textureName`): [`Block`](../modules.md#block-8)
...
▸ **getBlockByVoxel**(`vx`, `vy`, `vz`): [`Block`](../modules.md#block-8)
...
▸ **getBlockByWorld**(`wx`, `wy`, `wz`): [`Block`](../modules.md#block-8)
...
| `vy` | `number` | The voxel's Y position. |
| `vz` | `number` | The voxel's Z position. |
| `color` | [`LightColor`](../modules.md#lightcolor-8) | The color of the torch light to get. |
...
is within [WorldServerParams.minChunk](../modules.md#worldserverparams-8) and [WorldServerParams.maxChunk](../modules.md#worldserverparams-8).
...
[World.chunks.toUpdate](World.md#chunks-8) and scaffolded to the server [WorldClientParams.maxUpdatesPerTick](../modules.md#worldclientparams-8) times
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `updates` | [`BlockUpdate`](../modules.md#blockupdate-8)[] | A list of updates to send to the server. |
...
Use [getPreviousVoxelByVoxel](World.md#getpreviousvoxelbyvoxel-8) and [getPreviousVoxelByWorld](World.md#getpreviousvoxelbyworld-8) to get the previous
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `opaque?` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-8) | The chunk material that is used to render the opaque portions of the chunk meshes. |
| `transparent?` | { `back`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-8) ; `front`: [`CustomShaderMaterial`](../modules.md#customshadermaterial-8)  } | The chunk materials that are used to render the transparent portions of the chunk meshes. This consists of two sides of the chunk mesh, front and back. |
| `transparent.back` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-8) | The back side of the chunk mesh's transparent material. |
| `transparent.front` | [`CustomShaderMaterial`](../modules.md#customshadermaterial-8) | The front side of the chunk mesh's transparent material. |

___

### params

• **params**: [`WorldParams`](../modules.md#worldparams-8) = `{}`

Parameters to configure the world. This is a combination of the client-side parameters, [WorldClientParams](../modules.md#worldclientparams-8),
and the server-side parameters, [WorldServerParams](../modules.md#worldserverparams-8). The server-side parameters are defined on the server, and
...
| `atlas` | { `value`: `Texture`  } | The 2D texture atlas that is used to render the chunk. This will be set after [atlas](World.md#atlas-8) is generated. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `params` | `Partial`<[`WorldClientParams`](../modules.md#worldclientparams-8)\> | The client-side parameters to configure the world. |
