...
• **params**: [`ChunkParams`](../modules.md#chunkparams-198)
...
through [ChunkUtils.getChunkName](ChunkUtils.md#getchunkname-198).
...
| `params` | [`ChunkParams`](../modules.md#chunkparams-198) | The parameters to create a new chunk. |
...
| `vy` | `number` | The y voxel coordinate |
| `vz` | `number` | The z voxel coordinate |
| `color` | [`LightColor`](../modules.md#lightcolor-198) | The color of the light to get at the given voxel coordinate. |
...
| `color` | [`LightColor`](../modules.md#lightcolor-198) | The color of the light to set at the given voxel coordinate. |
