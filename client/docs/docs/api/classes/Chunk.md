...
| `vy` | `number` | The y voxel coordinate |
| `vz` | `number` | The z voxel coordinate |
| `color` | [`LightColor`](../modules.md#lightcolor-410) | The color of the light to get at the given voxel coordinate. |
...
| `color` | [`LightColor`](../modules.md#lightcolor-410) | The color of the light to set at the given voxel coordinate. |
...
through [ChunkUtils.getChunkName](ChunkUtils.md#getchunkname-410).

___

### params

• **params**: [`ChunkParams`](../modules.md#chunkparams-410)
...
| `params` | [`ChunkParams`](../modules.md#chunkparams-410) | The parameters to create a new chunk. |
