...
• **params**: [`CharacterParams`](../modules.md#characterparams-82)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-82)\> | Parameters to create a Voxelize character. |
