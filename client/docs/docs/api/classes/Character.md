...
• **params**: [`CharacterParams`](../modules.md#characterparams-472)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-472)\> | Parameters to create a Voxelize character. |
