...
• **params**: [`CharacterParams`](../modules.md#characterparams-410)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-410)\> | Parameters to create a Voxelize character. |
