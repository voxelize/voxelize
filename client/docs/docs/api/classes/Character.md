...
• **params**: [`CharacterParams`](../modules.md#characterparams-128)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-128)\> | Parameters to create a Voxelize character. |
