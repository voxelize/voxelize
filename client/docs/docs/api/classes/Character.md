...
• **params**: [`CharacterParams`](../modules.md#characterparams-480)
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CharacterParams`](../modules.md#characterparams-480)\> | Parameters to create a Voxelize character. |
