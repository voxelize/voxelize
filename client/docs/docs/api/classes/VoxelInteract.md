...
- [VoxelInteract.potential](VoxelInteract.md#potential-94): The potential block placement. This is the data of a block's orientation that can be placed.
- [VoxelInteract.target](VoxelInteract.md#target-94): The targeted block. This is the voxel that the camera is looking at.
...
• **params**: [`VoxelInteractParams`](../modules.md#voxelinteractparams-94)
...
| `voxel` | [`Coords3`](../modules.md#coords3-94) | The 3D coordinates of the potential block placement. |
| `yRotation` | `number` | The rotation along the Y axis that the block placement's major axis should be facing. This only works if rotation is [PY_ROTATION](../modules.md#py_rotation-94) or [NY_ROTATION](../modules.md#ny_rotation-94). |

___

### target

• **target**: [`Coords3`](../modules.md#coords3-94)
...
| `params` | `Partial`<[`VoxelInteractParams`](../modules.md#voxelinteractparams-94)\> | Parameters to customize the [VoxelInteract](VoxelInteract.md) instance. |
...
• `get` **lookingAt**(): [`Block`](../modules.md#block-94)
...
If no block is targeted, then [VoxelInteract.target](VoxelInteract.md#target-94) and [VoxelInteract.potential](VoxelInteract.md#potential-94) will both be `null`.
