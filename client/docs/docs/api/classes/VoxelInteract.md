...
• **params**: [`VoxelInteractParams`](../modules.md#voxelinteractparams-198)
...
| Name | Type |
| :------ | :------ |
| `voxel` | [`Coords3`](../modules.md#coords3-198) |
| `rotation` | `number` |
| `yRotation` | `number` |
...
• **target**: [`Coords3`](../modules.md#coords3-198)
...
| `object` | `Object3D`<`Event`\> |
| `world` | [`World`](World.md) |
| `params` | `Partial`<[`VoxelInteractParams`](../modules.md#voxelinteractparams-198)\> |
...
• `get` **lookingAt**(): [`Block`](../modules.md#block-198)
