...
• **params**: [`VoxelInteractParams`](../modules.md#voxelinteractparams-90)
...
| Name | Type |
| :------ | :------ |
| `voxel` | [`Coords3`](../modules.md#coords3-90) |
| `rotation` | `number` |
| `yRotation` | `number` |
...
• **target**: [`Coords3`](../modules.md#coords3-90)
...
| `object` | `Object3D`<`Event`\> |
| `world` | [`World`](World.md) |
| `params` | `Partial`<[`VoxelInteractParams`](../modules.md#voxelinteractparams-90)\> |
...
• `get` **lookingAt**(): [`Block`](../modules.md#block-90)
