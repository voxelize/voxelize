...
- `Map`<`string`, [`EventHandler`](../modules.md#eventhandler-128)\>
...
Synonym for [on](Events.md#on-128), adds a listener to a Voxelize server event.
...
| `handler` | [`EventHandler`](../modules.md#eventhandler-128) | What to do when this event is received? |
...
Synonym for [addEventListener](Events.md#addeventlistener-128), adds a listener to a Voxelize server event.
If the payload cannot be parsed by JSON, `null` is set.
