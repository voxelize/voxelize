...
Registry is by default created by the world and is available as [World.registry](World.md#registry-472).
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-472)[] | A list of blocks received from the server. |
...
• **blocksById**: `Map`<`number`, [`Block`](../modules.md#block-472)\>
...
• **blocksByName**: `Map`<`string`, [`Block`](../modules.md#block-472)\>
...
• **ranges**: `Map`<`string`, [`TextureRange`](../modules.md#texturerange-472)\>
