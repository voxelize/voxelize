...
Registry is by default created by the world and is available as [registry](World.md#registry-8).
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-8)[] | A list of blocks received from the server. |
...
• **ranges**: `Map`<`string`, [`TextureRange`](../modules.md#texturerange-8)\>
