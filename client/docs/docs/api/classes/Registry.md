...
Registry is by default created by the world and is available as [World.registry](World.md#registry-410).
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-410)[] | A list of blocks received from the server. |
...
• **blocksById**: `Map`<`number`, [`Block`](../modules.md#block-410)\>
...
• **blocksByName**: `Map`<`string`, [`Block`](../modules.md#block-410)\>
...
• **ranges**: `Map`<`string`, [`TextureRange`](../modules.md#texturerange-410)\>
