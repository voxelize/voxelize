...
Registry is by default created by the world and is available as [World.registry](World.md#registry-480).
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-480)[] | A list of blocks received from the server. |
...
• **blocksById**: `Map`<`number`, [`Block`](../modules.md#block-480)\>
...
• **blocksByName**: `Map`<`string`, [`Block`](../modules.md#block-480)\>
...
• **ranges**: `Map`<`string`, [`TextureRange`](../modules.md#texturerange-480)\>
