...
Registry is by default created by the world and is available as [World.registry](World.md#registry-128).
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `blocks` | [`Block`](../modules.md#block-128)[] | A list of blocks received from the server. |
...
• **blocksById**: `Map`<`number`, [`Block`](../modules.md#block-128)\>
...
• **blocksByName**: `Map`<`string`, [`Block`](../modules.md#block-128)\>
