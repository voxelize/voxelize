...
• **ranges**: `Map`<`string`, [`TextureRange`](../modules.md#texturerange-556)\>
...
• **blocksByName**: `Map`<`string`, [`Block`](../modules.md#block-556)\>
...
• **blocksById**: `Map`<`number`, [`Block`](../modules.md#block-556)\>
