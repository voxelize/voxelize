...
when [RigidControls.connect](RigidControls.md#connect-384) is called.
...
Keep in mind that by calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-384), the body is
...
calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-384) to add a mesh for 2nd and 3rd person
view.
...
[RigidControls.connect](RigidControls.md#connect-384), which registers the keyboard inputs for the controls.
...
• **params**: [`RigidControlsParams`](../modules.md#rigidcontrolsparams-384)
...
• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-384)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-384)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-384)
...
| `options` | `Partial`<[`RigidControlsParams`](../modules.md#rigidcontrolsparams-384)\> | The options to initialize the controls with. |
