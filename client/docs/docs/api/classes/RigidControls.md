...
when [RigidControls.connect](RigidControls.md#connect-472) is called.
...
Keep in mind that by calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-472), the body is
...
calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-472) to add a mesh for 2nd and 3rd person
view.
...
[RigidControls.connect](RigidControls.md#connect-472), which registers the keyboard inputs for the controls.
...
• **params**: [`RigidControlsParams`](../modules.md#rigidcontrolsparams-472)
...
• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-472)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-472)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-472)
...
| `options` | `Partial`<[`RigidControlsParams`](../modules.md#rigidcontrolsparams-472)\> | The options to initialize the controls with. |
