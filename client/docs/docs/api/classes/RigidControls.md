...
when [RigidControls.connect](RigidControls.md#connect-94) is called.
...
Keep in mind that by calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-94), the body is
...
calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-94) to add a mesh for 2nd and 3rd person
view.
...
[RigidControls.connect](RigidControls.md#connect-94), which registers the keyboard inputs for the controls.
...
• **params**: [`RigidControlsParams`](../modules.md#rigidcontrolsparams-94)
...
• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-94)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-94)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-94)
...
| `options` | `Partial`<[`RigidControlsParams`](../modules.md#rigidcontrolsparams-94)\> | The options to initialize the controls with. |
