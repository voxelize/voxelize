...
when [RigidControls.connect](RigidControls.md#connect-480) is called.
...
Keep in mind that by calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-480), the body is
...
calling [RigidControls.attachCharacter](RigidControls.md#attachcharacter-480) to add a mesh for 2nd and 3rd person
view.
...
[RigidControls.connect](RigidControls.md#connect-480), which registers the keyboard inputs for the controls.
...
• **params**: [`RigidControlsParams`](../modules.md#rigidcontrolsparams-480)
...
• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-480)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-480)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-480)
...
| `options` | `Partial`<[`RigidControlsParams`](../modules.md#rigidcontrolsparams-480)\> | The options to initialize the controls with. |
