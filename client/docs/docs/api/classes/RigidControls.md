...
• **params**: [`RigidControlsParams`](../modules.md#rigidcontrolsparams-184)
...
• **state**: [`RigidControlState`](../modules.md#rigidcontrolstate-184)
...
• `get` **voxel**(): [`Coords3`](../modules.md#coords3-184)
...
• `get` **chunk**(): [`Coords2`](../modules.md#coords2-184)
