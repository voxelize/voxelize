...
When using [Clouds.update](Clouds.md#update-410), new clouds will be generated if the center of the grid
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CloudsParams`](../modules.md#cloudsparams-410)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **params**: [`CloudsParams`](../modules.md#cloudsparams-410)
...
position passed into [Clouds.update](Clouds.md#update-410).
