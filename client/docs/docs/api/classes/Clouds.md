...
When using [Clouds.update](Clouds.md#update-94), new clouds will be generated if the center of the grid
...
| :------ | :------ | :------ |
| `params` | `Partial`<[`CloudsParams`](../modules.md#cloudsparams-94)\> | Parameters used to create a new [Clouds](Clouds.md) instance. |
...
• **params**: [`CloudsParams`](../modules.md#cloudsparams-94)
...
position passed into [Clouds.update](Clouds.md#update-94).
