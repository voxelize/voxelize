...
You can change the above bindings by calling [Inputs.remap](Inputs.md#remap-128) with the corresponding input identifiers, namely
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-128) | `{}` | The specific parameters of the key to listen for. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-128) | `undefined` | The type of click to listen for. Either "left", "middle" or "right". |
...
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-128) | - |
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-128) | The specifics of the key to unbind. |
