...
You can change the above bindings by calling [remap](Inputs.md#remap-8) with the corresponding input identifiers, namely
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-8) | `{}` | The specific parameters of the key to listen for. |
