...
| :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-198) | Which mouse button to register on. |
...
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-198) | Which pressing occasion should the event be fired. Defaults to "keydown". |
...
| `key` | `string` |
| `specifics` | `Object` |
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-198) |
