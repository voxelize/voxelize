...
You can change the above bindings by calling [Inputs.remap](Inputs.md#remap-480) with the corresponding input identifiers, namely
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-480) | `{}` | The specific parameters of the key to listen for. |
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `type` | [`ClickType`](../modules.md#clicktype-480) | `undefined` | The type of click to listen for. Either "left", "middle" or "right". |
...
| `specifics.occasion?` | [`InputOccasion`](../modules.md#inputoccasion-480) | - |
...
| `specifics` | [`InputSpecifics`](../modules.md#inputspecifics-480) | The specifics of the key to unbind. |
