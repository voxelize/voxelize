...
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-156) | The extra parameters to process the image voxelization. |
...
| Name | Type |
| :------ | :------ |
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-156) |
| `url` | `string` |
