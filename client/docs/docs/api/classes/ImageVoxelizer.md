...
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-384) | The extra parameters to process the image voxelization. |
...
| Name | Type |
| :------ | :------ |
| `params` | [`ImageVoxelizerParams`](../modules.md#imagevoxelizerparams-384) |
| `url` | `string` |
