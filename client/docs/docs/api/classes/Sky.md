...
[CanvasBox](CanvasBox.md).[boxLayers](CanvasBox.md#boxlayers-128)
...
[CanvasBox](CanvasBox.md).[depth](CanvasBox.md#depth-128)
...
[CanvasBox](CanvasBox.md).[height](CanvasBox.md#height-128)
...
• **params**: [`CanvasBoxParams`](../modules.md#canvasboxparams-128)

Parameters for creating a canvas box.

#### Inherited from

[CanvasBox](CanvasBox.md).[params](CanvasBox.md#params-128)
...
The bottom color of the sky gradient. Change this by calling [Sky.setBottomColor](Sky.md#setbottomcolor-128).
...
The middle color of the sky gradient. Change this by calling [Sky.setMiddleColor](Sky.md#setmiddlecolor-128).
...
The top color of the sky gradient. Change this by calling [Sky.setTopColor](Sky.md#settopcolor-128).
...
[CanvasBox](CanvasBox.md).[width](CanvasBox.md#width-128)
...
[CanvasBox](CanvasBox.md).[constructor](CanvasBox.md#constructor-128)
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `side` | [`BoxSides`](../modules.md#boxsides-128) \| [`BoxSides`](../modules.md#boxsides-128)[] | `undefined` | The side(s) of the box layer to draw on. |
| `art` | `Texture` \| [`ArtFunction`](../modules.md#artfunction-128) \| `Color` | `undefined` | The art or art function to draw on the box layer's side. |
...
[CanvasBox](CanvasBox.md).[paint](CanvasBox.md#paint-128)
