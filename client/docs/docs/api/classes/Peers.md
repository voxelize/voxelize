...
Override [Peers.packInfo](Peers.md#packinfo-128) to customize the information that is sent to other peers.
...
| `params` | `Partial`<[`PeersParams`](../modules.md#peersparams-128)\> | Parameters to customize the effect. |
...
• **params**: [`PeersParams`](../modules.md#peersparams-128)
...
should not be overridden unless you know what you are doing. Internally, this calls [Peers.createPeer](Peers.md#createpeer-128)
