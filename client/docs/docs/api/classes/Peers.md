...
Override [packInfo](Peers.md#packinfo-8) to customize the information that is sent to other peers.
...
| `params` | `Partial`<[`PeersParams`](../modules.md#peersparams-8)\> | Parameters to customize the effect. |
...
• **params**: [`PeersParams`](../modules.md#peersparams-8)
...
should not be overridden unless you know what you are doing. Internally, this calls [createPeer](Peers.md#createpeer-8)
