...
Override [Peers.packInfo](Peers.md#packinfo-94) to customize the information that is sent to other peers.
...
| `params` | `Partial`<[`PeersParams`](../modules.md#peersparams-94)\> | Parameters to customize the effect. |
...
• **params**: [`PeersParams`](../modules.md#peersparams-94)
...
should not be overridden unless you know what you are doing. Internally, this calls [Peers.createPeer](Peers.md#createpeer-94)
