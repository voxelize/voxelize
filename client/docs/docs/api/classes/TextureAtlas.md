...
• **params**: [`TextureAtlasParams`](../modules.md#textureatlasparams-8)
...
| `ranges` | `Map`<`string`, [`TextureRange`](../modules.md#texturerange-8)\> | The ranges on the texture atlas generated by the server. |
| `params` | [`TextureAtlasParams`](../modules.md#textureatlasparams-8) | The parameters used to create the texture atlas. |
