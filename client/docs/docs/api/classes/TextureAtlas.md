...
• **params**: [`TextureAtlasParams`](../modules.md#textureatlasparams-110)
...
| `ranges` | `Map`<`string`, [`TextureRange`](../modules.md#texturerange-210)\> | The ranges on the texture atlas generated by the server. |
| `params` | [`TextureAtlasParams`](../modules.md#textureatlasparams-110) | The parameters used to create the texture atlas. |
