...
• **params**: [`TextureAtlasParams`](../modules.md#textureatlasparams-128)
...
| `ranges` | `Map`<`string`, [`TextureRange`](../modules.md#texturerange-128)\> | The ranges on the texture atlas generated by the server. |
| `params` | [`TextureAtlasParams`](../modules.md#textureatlasparams-128) | The parameters used to create the texture atlas. |
