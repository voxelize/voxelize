...
• **params**: [`TextureAtlasParams`](../modules.md#textureatlasparams-384)
...
| `ranges` | `Map`<`string`, [`TextureRange`](../modules.md#texturerange-384)\> | The ranges on the texture atlas generated by the server. |
| `params` | [`TextureAtlasParams`](../modules.md#textureatlasparams-384) | The parameters used to create the texture atlas. |
