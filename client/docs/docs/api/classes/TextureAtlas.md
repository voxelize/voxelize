...
• **params**: [`TextureAtlasParams`](../modules.md#textureatlasparams-480)
...
| `ranges` | `Map`<`string`, [`TextureRange`](../modules.md#texturerange-480)\> | The ranges on the texture atlas generated by the server. |
| `params` | [`TextureAtlasParams`](../modules.md#textureatlasparams-480) | The parameters used to create the texture atlas. |
