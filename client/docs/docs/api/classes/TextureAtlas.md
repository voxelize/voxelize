...
• **params**: [`TextureAtlasParams`](../modules.md#textureatlasparams-74)
...
| `ranges` | `Map`<`string`, [`TextureRange`](../modules.md#texturerange-74)\> | The ranges on the texture atlas generated by the server. |
| `params` | [`TextureAtlasParams`](../modules.md#textureatlasparams-74) | The parameters used to create the texture atlas. |
