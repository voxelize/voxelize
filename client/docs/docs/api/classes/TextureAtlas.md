...
• **params**: [`TextureAtlasParams`](../modules.md#textureatlasparams-94)
...
| `ranges` | `Map`<`string`, [`TextureRange`](../modules.md#texturerange-94)\> | The ranges on the texture atlas generated by the server. |
| `params` | [`TextureAtlasParams`](../modules.md#textureatlasparams-94) | The parameters used to create the texture atlas. |
