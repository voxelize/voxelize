...
when [Perspective.connect](Perspective.md#connect-384) is called.
...
• **params**: [`PerspectiveParams`](../modules.md#perspectiveparams-384)
...
| `params` | `Partial`<[`PerspectiveParams`](../modules.md#perspectiveparams-384)\> | Parameters to configure the perspective. |
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-384) if it is implemented.
