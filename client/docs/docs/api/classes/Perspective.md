...
when [Perspective.connect](Perspective.md#connect-94) is called.
...
• **params**: [`PerspectiveParams`](../modules.md#perspectiveparams-94)
...
| `params` | `Partial`<[`PerspectiveParams`](../modules.md#perspectiveparams-94)\> | Parameters to configure the perspective. |
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-94) if it is implemented.
