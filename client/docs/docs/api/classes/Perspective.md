...
when [connect](Perspective.md#connect-8) is called.
...
• **params**: [`PerspectiveParams`](../modules.md#perspectiveparams-8)
...
| `params` | `Partial`<[`PerspectiveParams`](../modules.md#perspectiveparams-8)\> | Parameters to configure the perspective. |
...
Setter for the perspective's state. This will call [onChangeState](Perspective.md#onchangestate-8) if it is implemented.
