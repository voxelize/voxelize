...
when [Perspective.connect](Perspective.md#connect-156) is called.
...
• **params**: [`PerspectiveParams`](../modules.md#perspectiveparams-156)
...
| `params` | `Partial`<[`PerspectiveParams`](../modules.md#perspectiveparams-156)\> | Parameters to configure the perspective. |
...
Setter for the perspective's state. This will call [Perspective.onChangeState](Perspective.md#onchangestate-156) if it is implemented.
