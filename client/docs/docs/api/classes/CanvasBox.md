...
| Name | Type |
| :------ | :------ |
| `params` | `Partial`<[`CanvasBoxParams`](../modules.md#canvasboxparams-184)\> |
...
| `listener` | `EventListener`<`Event`, `T`, [`CanvasBox`](CanvasBox.md)\> | The function that gets called when the event is fired. |
...
| `listener` | `EventListener`<`Event`, `T`, [`CanvasBox`](CanvasBox.md)\> | The listener function that gets removed. |
...
▸ **applyQuaternion**(`quaternion`): [`CanvasBox`](CanvasBox.md)
...
▸ **rotateOnAxis**(`axis`, `angle`): [`CanvasBox`](CanvasBox.md)
...
▸ **rotateOnWorldAxis**(`axis`, `angle`): [`CanvasBox`](CanvasBox.md)
...
▸ **rotateX**(`angle`): [`CanvasBox`](CanvasBox.md)
...
▸ **rotateY**(`angle`): [`CanvasBox`](CanvasBox.md)
...
▸ **rotateZ**(`angle`): [`CanvasBox`](CanvasBox.md)
...
▸ **translateOnAxis**(`axis`, `distance`): [`CanvasBox`](CanvasBox.md)
...
▸ **translateX**(`distance`): [`CanvasBox`](CanvasBox.md)
...
▸ **translateY**(`distance`): [`CanvasBox`](CanvasBox.md)
...
▸ **translateZ**(`distance`): [`CanvasBox`](CanvasBox.md)
...
▸ **add**(...`object`): [`CanvasBox`](CanvasBox.md)
...
▸ **remove**(...`object`): [`CanvasBox`](CanvasBox.md)
...
▸ **removeFromParent**(): [`CanvasBox`](CanvasBox.md)
...
▸ **attach**(`object`): [`CanvasBox`](CanvasBox.md)
...
▸ **clone**(`recursive?`): [`CanvasBox`](CanvasBox.md)
...
▸ **copy**(`source`, `recursive?`): [`CanvasBox`](CanvasBox.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `source` | [`CanvasBox`](CanvasBox.md) |
| `recursive?` | `boolean` |
