...
WASM-pack `failureSummaries[]` entries include `checkIndex`, `command`, `args`, and `argCount` for stable index correlation and deterministic command diagnostics.
