...
Passion project, not affiliated with Minecraft. [@shaoruu](https://github.com/shaoruu)

## Features

- Custom blocks, decoupled server, realtime multiplayer
- Multithreaded chunk generation, world persistence, AABB physics
- Configurable chat, command registry, debug panels
