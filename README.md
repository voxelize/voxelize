...
Aggregate preflight reports include `selectedCheckMetadata`, `selectedCheckScripts`, and `selectedCheckScriptCount` so automation can map selected checks directly to executable scripts.
