...
Aggregate preflight reports include `availableCheckScripts`/`availableCheckScriptCount` and `availableCheckIndices`/`availableCheckIndexCount` for direct canonical check-to-script/index lookup.
