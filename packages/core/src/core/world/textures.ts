...
export class AtlasTexture extends CanvasTexture {
   ...
   *
   * @param countPerSide The amount of textures per side in the atlas.
   * @param dimension The texture dimension of each atlas tile.
   * @param canvas The canvas used to render this atlas.
